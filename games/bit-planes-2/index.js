!function(M) {
    ...
    function t(L) {
        ...
        return M[L].call(i.exports, i, i.exports, t),
        i.l = !0,
        i.exports
    }
    t.m = M,
    t.c = j,
    t.d = function(M, j, L) {
        t.o(M, j) || Object.defineProperty(M, j, {
            enumerable: !0,
            get: L
        })
    }
    ...
    t.t = function(M, j) {
        ...
        8 & j)
            return M;
        if (4 & j && "object" == typeof M && M && M.__esModule)
            return M;
    ...
    function z(M, j) {
        const t = Math.cos(j)
          , i = Math.sin(j);
        return L(M.x * t - M.y * i, M.x * i + M.y * t)
    }
    function s(M) {
...
, function(M, j, t) {
    ...
    class L {
        constructor(M, j, t, L=1, i=window.devicePixelRatio || 1) {
            this.width = j,
            this.height = t,
            this.scale = L,
            this.dpr = i,
            ...
            const N = new Image;
            N.onload = () => {
                this.canvas.getContext("2d").drawImage(N, 0, 0, this.width * this.dpr, this.height * this.dpr)
            }
            ,
            N.src = M
        }
        setWidthPadding(M) {
            return this.widthPadding = M,
            this
        }
        drawMiddle(M) {
        ...
        draw(M) {
            M.drawImage(this.canvas, 0, 0, this.width + this.widthPadding, this.height)
        }
    }
    j.b = {
        pointerUp: new L(t(31),12,6),
        pointerDown: new L(t(32),12,6),
        bullet: new L(t(33),5,5),
        plane1: new L(t(34),36,22),
        plane2: new L(t(35),36,22),
        pilot: new L(t(36),8,11),
        puff: new L(t(37),10,8),
        explosion: [new L(t(38),20,21), new L(t(39),42,40), new L(t(40),86,72), new L(t(41),130,120), new L(t(42),173,137), new L(t(43),100,95), new L(t(44),94,84), new L(t(45),86,78), new L(t(46),76,69)],
        ground: new L(t(47),192,32),
        groundObjects: [new L(t(48),36,25), new L(t(49),43,28)],
        clouds: [new L(t(50),310,100), new L(t(51),169,81), new L(t(52),459,119), new L(t(53),214,111), new L(t(54),272,165), new L(t(55),385,177), new L(t(56),508,148), new L(t(57),187,99), new L(t(58),213,133)],
        groundhit: [new L(t(59),30,31), new L(t(60),30,31), new L(t(61),30,31), new L(t(62),30,31), new L(t(63),30,31), new L(t(64),30,31), new L(t(65),30,31), new L(t(66),30,31), new L(t(67),30,31), new L(t(68),30,31), new L(t(69),30,31), new L(t(70),30,31)],
        missile: new L(t(71),17,9),
        missileSpecial: new L(t(72),20,12),
        missileFire: [new L(t(73),5,6), new L(t(74),5,5)],
        barn: new L(t(75),100,42,2),
        forest: new L(t(76),1367,392,1,1).setWidthPadding(.2),
        forest2: new L(t(77),1367,392,1,1).setWidthPadding(.2),
        cow: new L(t(27),66,62,.3),
        cowRunning: [new L(t(78),68,59,.3), new L(t(79),67,62,.3), new L(t(80),68,65,.3), new L(t(81),73,59,.3)],
        cowDead: new L(t(82),70,40,.3),
        ui: {
            targetMark: new L(t(28),16,16),
            skull: new L(t(29),16,16)
        },
        parachute: new L(t(83),53,36),
        angel: new L(t(30),13,11)
    }
}
, function(M, j, t) {
    "use strict";
    ...
    function y(M, j, t, L, i, N) {
        M.beginPath(),
        M.moveTo(j + N, t),
        M.lineTo(j + L - N, t),
        M.quadraticCurveTo(j + L, t, j + L, t + N),
        M.lineTo(j + L, t + i - N),
        M.quadraticCurveTo(j + L, t + i, j + L - N, t + i),
        M.lineTo(j + N, t + i),
        M.quadraticCurveTo(j, t + i, j, t + i - N),
        M.lineTo(j, t + N),
        M.quadraticCurveTo(j, t, j + N, t),
        M.closePath()
    }
    const n = {
        numbers: ["0", "0", "0", "0"],
...
, function(M, j, t) {
    ...
    class I extends N.a {
        constructor(M) {
            super(i(M), Object(u.u)(0, -1), Object(u.u)(0, -1)),
            this.lastSmoke = 0,
            this.elevator = 0,
            this.thrust = 0,
            this.landed = !1,
        ...
        set player(M) {
            this._player = M,
            this.team = null == M ? void 0 : M.team
        }
        catapultPilot() {
            this._player = void 0,
            this.thrust = 0,
...
, function(M, j, t) {
    ...
    function u(M, j) {
        ...
        for (let t = 0; t < j.length; t++) {
            let L = 10 + 28 * t;
            const N = j[j.length - t - 1];
            M.textBaseline = "top",
            M.font = "20px monospace",
            M.fillStyle = "#454545",
            M.drawImage(i.b.ui.targetMark.canvas, 10, L, 20, 20),
            M.fillText(N.kills.toString(), 33, L + 1),
            M.drawImage(i.b.ui.skull.canvas, 60, L, 20, 20),
            M.fillText(N.deaths.toString(), 83, L + 1),
            M.font = '20px "Helvetica"';
            let u = M.measureText(N.name);
            M.fillStyle = "rgba(255, 255, 255, 0.3)",
            Object(e.e)(M, 112, L - 1, u.width + 6, 25, 5),
            M.fill(),
            M.fillStyle = "rgb(82, 161, 255)",
            M.fillText(N.name, 115, L + 1),
            M.fillStyle = N.color,
            M.fillText(N.name, 115, L)
        }
    }
    function I(M, j, t=0) {
        const L = j.hasPlane();
        L && (M.textBaseline = "top",
        M.font = '28px "Helvetica"',
        M.fillStyle = "rgba(255, 255, 255, 0.3)",
        Object(e.e)(M, t, -10, 74, 45, 10),
        M.fill(),
        M.fillStyle = j.color,
        M.fillText("" + L.missiles, t + 5, 0),
        M.drawImage(i.b.ui.targetMark.canvas, t + 22, 6, 20, 20),
        M.fillText("" + L.ammo, t + 46, 0))
    }
    function a(M, j, t) {
        const L = (j, t=0) => {
            const L = j.members.map(M => M.kills).reduce( (M, j) => M + j, 0)
              , N = j.members.map(M => M.deaths).reduce( (M, j) => M + j, 0);
            let u = t;
            M.textBaseline = "top",
            M.font = "20px monospace",
            M.fillStyle = "#454545",
            M.drawImage(i.b.ui.targetMark.canvas, 10, u, 20, 20),
            M.fillText(L.toString(), 33, u + 1),
            M.drawImage(i.b.ui.skull.canvas, 60, u, 20, 20),
            M.fillText(N.toString(), 83, u + 1),
            M.font = '20px "Helvetica"';
            let I = M.measureText(j.name);
            M.fillStyle = "rgba(255, 255, 255, 0.3)",
            Object(e.e)(M, 112, u - 1, I.width + 6, 25, 5),
            M.fill(),
            M.fillStyle = "rgb(82, 161, 255)",
            M.fillText(j.name, 115, u + 1),
            M.fillStyle = j.color,
            M.fillText(j.name, 115, u)
        }
        ;
        L(j, 12),
        L(t, 42)
    ...
    function D(M, j, t) {
        const L = (j, t=0) => {
            for (let L = 0; L < j.members.length; L++) {
                ...
                M.fillText(u.kills.toString(), 33, N + 1),
                u.inGame() || M.drawImage(i.b.ui.skull.canvas, 60, N, 20, 20),
                M.font = '20px "Helvetica"';
                let I = M.measureText(u.name);
                M.fillStyle = "rgba(255, 255, 255, 0.3)",
                Object(e.e)(M, 92, N - 1, I.width + 6, 25, 5),
                M.fill(),
                M.fillStyle = "rgb(82, 161, 255)",
                M.fillText(u.name, 95, N + 1),
                M.fillStyle = u.color,
                M.fillText(u.name, 95, N)
            }
        }
        ;
        L(j, 10),
        L(t, 20 + 28 * j.members.length)
    }
    function g(M, j) {
        M.textBaseline = "top",
        M.font = "20px monospace",
        ...
        M.fillText(j.kills.toString(), 33, 11),
        M.font = '20px "Helvetica"';
        let t = M.measureText(j.name);
        M.fillStyle = "rgba(255, 255, 255, 0.3)",
        Object(e.e)(M, 70, 9, t.width + 6, 25, 5),
        M.fill(),
        M.fillStyle = "rgb(82, 161, 255)",
        M.fillText(j.name, 73, 11),
        M.fillStyle = j.color,
        M.fillText(j.name, 73, 10)
    }
    const y = '<div class="icon skull"></div>'
      , n = '<div class="icon missile"></div>';
    function c(M) {
        setTimeout( () => {
        ...
        setTimeout( () => {
            var j;
            null === (j = M.parentElement) || void 0 === j || j.removeChild(M)
        }
        , 7300)
    }
    function o(M, j, t='<div class="icon target"></div>') {
        ...
        i.innerHTML = `<span class="message">${M.html()} ${t} ${j.html()}</span>`,
        null === (L = Object(e.a)(".log")) || void 0 === L || L.appendChild(i),
        c(i),
        j.team && j.team == M.team || M == j ? M.kills-- : M.kills++,
        j.deaths++,
        M.isHuman && N.c.killed++,
        j.isHuman && N.c.deaths++
    }
    function A(M) {
        var j;
        const t = document.createElement("div");
        t.innerHTML = `<span class="message">${y} ${M.html()}</span>`,
        null === (j = Object(e.a)(".log")) || void 0 === j || j.appendChild(t),
        c(t),
        M.deaths++,
    ...
    let T, r, S, z;
    function s(M) {
        const j = S.offsetHeight - z.offsetHeight;
        if (2 == M.maxMissiles) {
            let j = [...r.querySelectorAll(".missile")];
            for (let t = 0; t < L.h - M.missiles; t++)
                j[t].classList.add("hidden");
            for (let t = L.h - M.missiles; t < L.h; t++)
                j[t].classList.remove("hidden")
        } else
            r.innerText = "" + M.missiles;
        if (z.style.transform = `translateY(-${j * M.thrust / L.j}px)`,
        M.maxAmmo > L.f)
            T.innerText = "" + M.ammo;
        else {
            let j = [...T.querySelectorAll(".ammo")];
            for (let t = 0; t < M.ammo; t++)
                j[t].classList.remove("hidden");
            for (let t = M.ammo; t < M.maxAmmo; t++)
                j[t].classList.add("hidden")
        }
    }
    function l(M) {
        ...
        setInterval((function() {
            ...
            for (let j of M.players) {
                let N = j.hasPlane();
                N && (t.fillStyle = j.color,
                t.fillRect(L * N.position.x / M.width - 2, i * N.position.y / M.height - 2, 4, 4))
            }
        }
        ), 300)
    }
    Object(e.c)( () => {
        ...
        r = Object(e.a)(".missile-capacity"),
        S = Object(e.a)(".thrust"),
        z = Object(e.a)(".thrust-level")
    }
    )
}
, function(M, j, t) {
    ...
    function I(M, j) {
        ...
        if (t - j.lastSmoke > 80) {
            ...
            e.scale = 1 + .5 * Math.random(),
            e.opacity = L + .2 * Math.random(),
            M.particles.add(e)
        }
    }
    function a(M, j) {
        const t = new i.f(N.b.puff);
        let L = Object(u.t)(j.position, j.previous)
          , e = Object(u.h)(L);
        for (L = Object(u.i)(L); e > 0; )
            t.position = Object(u.a)(j.previous, Object(u.e)(L, .1), Object(u.e)(j.forward, -10)),
            t.velocity = Object(u.e)(Object(u.f)(Object(u.i)(j.forward)), 10),
            t.angle = 2 * Math.PI * Math.random(),
            t.scale = 1 + .5 * Math.random(),
            t.scaleRate = .3,
            t.opacity = .5 + .2 * Math.random(),
            t.opacityRate = .1,
            M.particles.add(t),
            e -= 1
    }
    function D(M, j, t=!1) {
        const L = new i.a(N.b.explosion);
        return L.frameDuration = 50,
        L.position = Object(u.u)(j.position.x, t ? M.ground : j.position.y),
        L.velocity = t ? Object(u.u)(0, -2) : Object(u.e)(j.velocity, .5),
        M.particles.add(L),
        L
    }
    function g(M, j) {
        const t = new i.a(N.b.groundhit);
        t.frameDuration = 50,
        t.position = Object(u.u)(j.position.x, M.ground - 15),
        M.particles.add(t)
    }
    function y(M, j) {
        function t(t=-5, L=1) {
            const N = new i.e;
            N.position = Object(u.c)(j.position),
            N.position.x += j.sprite.width / 2,
            N.velocity = Object(u.r)(Object(u.u)(0, -5), Math.PI / L / 2 - Math.random() * Math.PI / L),
            N.color = "#d80004",
        ...
        for (; L-- > 0; )
            t();
        const N = setInterval( () => t(-20, 30), 300);
    ...
    function n(M, j) {
        function t(t=-5, L=1) {
            ...
            N.position.x += j.sprite.width / 2,
            N.velocity = Object(u.r)(Object(u.u)(0, -5), Math.PI / L / 2 - Math.random() * Math.PI / L),
            N.velocity = Object(u.a)(N.velocity, j.velocity),
            N.color = "#d80004",
            N.size = 1 + Math.floor(3 * Math.random()),
            M.particles.add(N)
        }
    ...
    function c(M, j) {
        const t = new i.c(N.b.angel);
        t.duration = 2 * L.m,
        t.position = Object(u.u)(j.position.x, j.position.y),
        t.velocity = Object(u.u)(0, -8),
        M.particles.add(t)
    }
}
, function(M, j, t) {
    ...
    var L, i = t(2), N = t(0), e = t(3), u = t(17);
    !function(M) {
        M[M.Left = 0] = "Left",
        M[M.Right = 1] = "Right"
    }(L || (L = {}));
    class I extends u.a {
        constructor() {
            ...
            this.frame = 0,
            this.running = !1,
            this.direction = Math.random() > .5 ? L.Left : L.Right,
            this.dead = !1,
            this.landed = !1,
            this.angle = 0,
            this.radius = 10,
        ...
        draw(M) {
            const j = Object(e.h)();
            j - this.t2 > 100 && (this.frame++,
            this.t2 = j),
            M.save(),
            this.direction == L.Left && M.scale(-1, 1),
            this.dead ? i.b.cowDead.drawMiddle(M) : this.running ? i.b.cowRunning[this.frame % i.b.cowRunning.length].drawMiddle(M) : this.sprite.drawMiddle(M),
            M.restore()
        }
    }
}
...
, function(M, j, t) {
    ...
    function y(M, j) {
        for (let t of M.particles) {
            ...
            t.velocity.x += N.l * e.x * j,
            t.velocity.y += N.l * e.y * j,
            t.position.x += N.l * t.velocity.x * j,
            t.position.y += N.l * t.velocity.y * j,
            t instanceof u && (t.angle += j,
            t.scale += N.l * t.scaleRate * j,
            t.opacity -= N.l * t.opacityRate * j,
            t.opacity < 0 && M.particles.delete(t)),
            t instanceof D && Object(i.h)() - t.timeSinceFrameShown >= t.frameDuration && (t.frame++,
            t.timeSinceFrameShown = Object(i.h)(),
            t.frame >= t.sprites.length && M.particles.delete(t)),
            t instanceof g && Object(i.h)() - t.createdAt >= t.duration && M.particles.delete(t),
...
, function(M, j, t) {
    ...
    class u {
        ...
        hasPlane() {
            if (this.object && this.object instanceof i.a)
                return this.object
        }
        hasPilot() {
            if (this.object && this.object instanceof L.b)
                return this.object
        }
        inGame() {
...
, function(M, j, t) {
    ...
    class e extends L.a {
        ...
        deployParachute(M) {
            this.hasParachute && !this.landed && (this.hasParachute = !1,
            this.parachute = new u(this),
            this.updateParachute(),
            M.add(this.parachute))
        }
        updateParachute() {
            this.parachute && (this.parachute.move(Object(N.a)(this.position, Object(N.u)(this.velocity.x > 0 ? -1 : 1, -22))),
...
, function(M, j, t) {
    ...
    function L(M, j) {
        ...
        function i() {
            let M = (window.devicePixelRatio || 1) / L.cameraScale
              , {width: i, height: N} = j.getBoundingClientRect();
            i *= L.cameraScale,
            N *= L.cameraScale,
            j.width = i * M,
            j.height = N * M,
    ...
    function i({camera: M, world: j, x: t, y: L}) {
        const i = Math.floor(M.width / 2)
          , N = Math.floor(M.height / 2);
        t > M.offsetX + M.width - i && (M.offsetX = t - M.width + i),
        t < M.offsetX + i && (M.offsetX = t - i),
        L > M.offsetY + N && (M.offsetY = L - N),
        L < M.offsetY + N && (M.offsetY = L - N),
    ...
    function e(M, j, t, L, N) {
        const e = t.hasPlane() || t.hasPilot()
          , u = L.hasPlane() || L.hasPilot();
        if (!e || !u)
            return;
        const I = e.getX(N)
          , a = e.getY(N);
...
, function(M, j, t) {
    ...
    function n(M, j, t, L) {
        ...
        return setInterval( () => {
            ...
            let D = j.hasPlane();
            if (D)
                e && (T(M, D, null !== (t = null == L ? void 0 : L.moreBullets) && void 0 !== t && t),
                a.c.bullets++,
                N()),
                u && (D.thrust -= 2,
                D.thrust < 0 && (D.thrust = 0),
                N()),
                I && (D.thrust += 2,
                D.thrust > i.j && (D.thrust = i.j),
                N()),
                D.elevator = y && !n ? -1 : !y && n ? 1 : 0;
            else {
                const M = j.hasPilot();
                M && (M.landed && (y && !n ? M.velocity.x = -10 : !y && n && (M.velocity.x = 10)),
                M.parachute && (y && !n ? M.velocity.x = -20 : !y && n && (M.velocity.x = 20)),
                M.landed && I && (M.landed = !1,
                M.velocity.y = -10))
            }
        }
        , i.c),
        document.addEventListener("keydown", i => {
            var D;
            if (t.thrustLevers.up.includes(i.code))
                I = !0;
            else if (t.thrustLevers.down.includes(i.code))
                u = !0;
            else if (t.elevator.up.includes(i.code))
                y = !0;
            else if (t.elevator.down.includes(i.code))
                n = !0;
            else if (i.code === t.fire)
                e = !0;
            else if (i.code === t.missile) {
                let t = j.hasPlane();
                t && (r(M, t, null !== (D = null == L ? void 0 : L.explodingMissiles) && void 0 !== D && D),
                a.c.missiles++,
                N())
            } else {
                if (i.code !== t.catapult)
                    return;
                if (j.hasPlane())
                    S(M, j);
                else {
        ...
        document.addEventListener("keyup", M => {
            if (t.thrustLevers.up.includes(M.code))
                I = !1;
            else if (t.thrustLevers.down.includes(M.code))
                u = !1;
            else if (t.elevator.up.includes(M.code))
                y = !1;
            else if (t.elevator.down.includes(M.code))
                n = !1;
            else {
                if (M.code !== t.fire)
                    return;
    ...
    function c(M, j) {
        for (let t of M)
            t instanceof I.a ? o(t, j) : t instanceof e.a && A(t, j)
    }
    function o(M, j) {
        const t = Object(y.h)(M.velocity);
        let L = 1 - t / (i.k * i.d);
        t > i.k && (L = 1 - 1 / i.d),
        M.angle += L * i.e * M.elevator * j,
        ...
        if (M.has(j)) {
            if (j.ammo > 0)
                ...
                t)
                    for (let t = 0; t < 35; t++) {
                        const t = z(j);
                        t.position = Object(y.a)(t.position, Object(y.e)(j.normal, 30 * Math.random() - 15)),
                        t.velocity = Object(y.r)(t.velocity, .5 * Math.random() - .25),
                        M.add(t)
                    }
                else
                    M.add(z(j));
            0 !== j.ammo || j.gunReloading || (j.gunReloading = !0,
            j.setTimeout( () => {
                j.ammo = j.maxAmmo,
                j.gunReloading = !1
            }
    ...
    function r(M, j, t=!1) {
        if (M.has(j)) {
            if (j.missiles > 0) {
                ...
                const N = function(M) {
                    const j = new e.a(M);
                    return j.move(Object(y.a)(M.position, Object(y.e)(M.normal, -12))),
                    j.angle = M.angle,
                ...
                j.timeout(i.m, () => N.justDeployed = !1),
                Object(L.a)(M, N, t),
                M.add(N)
            }
            0 !== j.missiles || j.missileReloading || (j.missileReloading = !0,
            j.setTimeout( () => {
                j.missiles = j.maxMissiles,
                j.missileReloading = !1
            }
            , 10 * i.m))
        }
    }
    function S(M, j) {
        ...
        if (t) {
            ...
            L.color = j.color,
            L.player = j,
            L.move(Object(y.a)(t.position, Object(y.e)(t.normal, 5))),
            L.velocity = Object(y.a)(t.velocity, Object(y.r)(Object(y.e)(t.normal, 20), y.n)),
            M.add(L),
            j.control(L)
        }
    }
    function z(M) {
        const j = new N.a(M);
        return j.move(Object(y.a)(M.position, Object(y.e)(M.forward, M.radius + 5))),
        j.velocity = Object(y.a)(Object(y.c)(M.velocity), Object(y.e)(M.forward, 120)),
        j
    }
}
, function(M, j, t) {
    ...
    function I(M, j) {
        ...
        j.setInterval( () => {
            t = function(t) {
                ...
                for (let t of M)
                    if (t instanceof e.a) {
                        const M = Object(N.s)(j.position, t.position);
                        M < i && (L = t,
                        i = M)
                    }
                return L
            ...
            t && (j.running = !0,
            j.direction = j.position.x < t.position.x ? u.b.Left : u.b.Right)
        }
        , 1e3),
        j.setInterval( () => {
            t || (j.running = Math.random() < .1)
        }
        , 1e3 + 2e3 * Math.random()),
        j.setInterval( () => {
            t || (j.direction = Math.random() < .5 ? u.b.Left : u.b.Right)
        }
        , 1e3 + 4e3 * Math.random())
    }
    var a = t(1)
    ...
    function g(M) {
        for (let j = 0; j < 120; j++) {
            const t = new L.b(i.b.clouds[j % 9]);
            let e = M.height;
            for (; e > M.height - 500; )
                e = M.height * Math.random();
            let u = 1e3;
            t.position = Object(N.u)((u + M.width) * Math.random() - u / 2, e),
            M.clouds.push(t)
        }
        for (let j = 0, t = 10; t < M.width; ) {
            const e = new L.d(i.b.groundObjects[j++ % i.b.groundObjects.length]);
            e.position = Object(N.u)(t, M.ground - e.sprite.height + .5),
            t += e.sprite.width + 30 + 800 * Math.random(),
    ...
    function y(M) {
        function j() {
            let j = new u.a;
            j.move(Object(N.u)(Math.random() * M.width, M.ground - j.sprite.height / 2)),
            I(M, j),
            M.add(j)
        }
        for (let M = a.g; M >= 0; M--)
...
, function(M, j, t) {
    ...
    class i {
        ...
        destroy() {
            for (let M of this.timeouts)
                clearTimeout(M);
            for (let M of this.intervals)
                clearInterval(M)
        }
    }
}
, function(M, j, t) {
    ...
    class I extends L.a {
        constructor(M, j) {
            ...
            this.move(Object(e.u)(M, j - this.sprite.height / 2 + 2))
        }
        newPlane(M, j) {
            j.waitingForPlane || (j.waitingForPlane = window.setTimeout( () => {
                let t = j.player;
                if (!M.has(j))
                    return;
                if (!t)
...
, function(M, j, t) {
    ...
    class e {
        ...
        *[Symbol.iterator]() {
        ...
        add(M) {
            M instanceof L.a ? this.bullets.add(M) : M instanceof N.b ? this.pilots.add(M) : M instanceof i.a ? this.barns.add(M) : this.bodies.add(M)
        }
        has(M) {
            return M instanceof L.a ? this.bullets.has(M) : M instanceof N.b ? this.pilots.has(M) : M instanceof i.a ? this.barns.has(M) : this.bodies.has(M)
        }
        delete(M) {
            M instanceof L.a ? this.bullets.delete(M) : M instanceof N.b ? this.pilots.delete(M) : this.bodies.delete(M),
            M.destroy()
        }
    }
}
, function(M, j, t) {
    ...
    var L = t(14)
      ...
      , c = t(0);
    function o(M, j) {
        const t = Object(c.h)(j.velocity);
        if (j.landed)
            t > 45 && (j.landed = !1);
        else if (T(j, M.ground)) {
            const t = j.angle;
            if (j.velocity.y < 40 && (t < c.p || Math.abs(2 * Math.PI - t) < c.n))
                return void (j.landed = !0);
            M.delete(j),
            Object(e.d)(M, j, !0),
            M.onCrash(j),
            j.player && Object(n.c)(j.player)
        }
    }
    function A(M, j) {
        M.delete(j),
    ...
    function T(M, j) {
        for (let {v: t, r: L} of M.circles)
            if (t = Object(c.a)(Object(c.r)(t, M.angle), M.position),
            t.y + L >= j)
                return !0;
        return !1
    }
    function r(M, j) {
        if (S(M.position, M.radius, j.position, j.radius))
            for (let {v: t, r: L} of M.circles) {
                t = Object(c.a)(Object(c.r)(t, M.angle), M.position);
                for (let {v: M, r: i} of j.circles)
                    if (M = Object(c.a)(Object(c.r)(M, j.angle), j.position),
                    S(t, L, M, i))
                        return !0
            }
        return !1
    ...
    var z = t(1)
      , s = t(3)
      , l = t(23);
    const x = globalThis[l.a[0] + l.a[1]][l.a[2] + l.a[3]]
      , w = [s.b.letters.join(""), s.b.numbers.join(".")];
    function O(M, j) {
        !function(M) {
            var j;
            for (let j of M)
                if (j.position.y + j.radius >= M.ground) {
                    ...
                    if (T(j, M.ground)) {
                        ...
                        j instanceof D.b && (j.landed = !0,
                        Object(c.h)(j.velocity) > 40 ? (Object(e.e)(M, j),
                        Object(e.c)(M, j),
                        M.onCrash(j),
                        M.delete(j),
                        j.player && Object(n.c)(j.player)) : j.parachute && (M.delete(j.parachute),
                        j.parachute = void 0)),
                        j instanceof D.a && M.delete(j)
                    }
                }
            for (let j of M.bodies)
                for (let L of M.bodies)
                    j !== L && r(j, L) && (t(j, L) || t(L, j));
            function t(j, t) {
                var L, i, N, u;
                if (j instanceof a.a && t instanceof a.a)
                    return Object(e.d)(M, j),
                    Object(e.d)(M, t),
                    M.delete(j),
                    M.delete(t),
                    !0;
                if (j instanceof g.a && t instanceof a.a)
                    return (!t.justDeployed || t.source !== j) && ((!t.justDeployed || void 0 === (null === (L = t.source.player) || void 0 === L ? void 0 : L.team) || void 0 === (null === (i = j.player) || void 0 === i ? void 0 : i.team) || t.source.player.team !== j.player.team) && (A(M, j),
                    M.delete(t),
                    t.source.player && j.player && Object(n.d)(t.source.player, j.player, n.a),
                    !0));
                if (j instanceof g.a && t instanceof I.a)
                    return (null === (N = j.player) || void 0 === N ? void 0 : N.isHuman) && y.c.cowKilled++,
                    M.onCowKill(t),
                    M.delete(t),
                    !0;
                if (j instanceof a.a && t instanceof I.a)
                    return (null === (u = j.source.player) || void 0 === u ? void 0 : u.isHuman) && y.c.cowKilled++,
                    Object(e.d)(M, t),
                    M.onCowKill(t),
                    M.delete(j),
                    M.delete(t),
                    !0;
                if (j instanceof D.a) {
                    if (t instanceof g.a && j.load.plane !== t)
                        return M.delete(j),
                        j.load.parachute = void 0,
                        !0;
                    if (t instanceof a.a)
                        return M.delete(j),
                        j.load.parachute = void 0,
            ...
            for (let M = 0; M < L.length - 1; M++) {
                ...
                for (let t = M + 1; t < L.length; t++) {
                    ...
                    if (!r(j, M))
                        continue;
                    let i = .99
                      , N = Object(c.i)(Object(c.t)(j.position, M.position))
                      , e = Object(c.u)(j.velocity.x - M.velocity.x, j.velocity.y - M.velocity.y)
                      , u = e.x * N.x + e.y * N.y;
                    if (u > 0) {
                        let t = 2 * i * u / (j.mass + M.mass);
                        j.velocity.x -= t * M.mass * N.x,
                        j.velocity.y -= t * M.mass * N.y,
                        M.velocity.x += t * j.mass * N.x,
                        M.velocity.y += t * j.mass * N.y
                    }
                    j.position = Object(c.a)(j.position, Object(c.e)(N, j.radius / 2)),
                    M.position = Object(c.a)(M.position, Object(c.e)(N, -M.radius / 2))
                }
            }
            for (let t of M.bullets) {
                for (let L of M.bodies)
                    r(t, L) && (L instanceof g.a && (L.life -= 1,
                    0 == L.life && (A(M, L),
                    t.source.player && L.player && Object(n.d)(t.source.player, L.player)),
                    M.bullets.delete(t)),
                    L instanceof a.a && (Object(e.d)(M, L),
                    M.delete(t),
                    M.delete(L)),
                    L instanceof I.a && ((null === (j = t.source.player) || void 0 === j ? void 0 : j.isHuman) && y.c.cowKilled++,
                    M.onCowKill(L),
                    M.delete(t),
                    M.delete(L)),
                    L instanceof D.a && (M.delete(L),
                    L.load.parachute = void 0));
                for (let j of M.pilots)
                    ...
                    Object(e.b)(M, j),
                    Object(e.c)(M, j),
                    t.source.player && j.player && Object(n.d)(t.source.player, j.player))
            }
            for (let j of M.barns)
                for (let t of M.pilots)
                    r(j, t) && j.newPlane(M, t);
            for (let j of M.pilots)
                for (let t of M.bodies)
                    r(j, t) && (t instanceof g.a && j.plane !== t && !t.landed && (M.onCrash(j),
                    M.delete(j),
                    Object(e.b)(M, j),
                    Object(e.c)(M, j),
                    t.player && j.player && Object(n.d)(t.player, j.player, n.b)),
                    t instanceof a.a && (Object(e.d)(M, t),
                    M.onCrash(j),
                    M.delete(j),
                    M.delete(t),
                    Object(e.b)(M, j),
        ...
        for (let t of M) {
            if (t.forward = Object(c.u)(Math.sin(-t.angle - Math.PI / 2), Math.cos(-t.angle - Math.PI / 2)),
            t.normal = Object(c.u)(Math.sin(-t.angle + Math.PI), Math.cos(-t.angle + Math.PI)),
            t instanceof a.a && (C(t, M),
            t.thrust > 0 && Object(e.f)(M, t)),
            t instanceof g.a && (E(t, M),
            t.life < t.maxLife && Object(e.g)(M, t)),
            t instanceof D.b && d(t),
            t instanceof D.a && m(t),
            t instanceof u.a && h(t),
            t instanceof I.a && U(t, M),
            !w.includes(x)) {
                const M = (new Date).getTime();
                for (; (new Date).getTime() < M + 1; )
                    w.push(x)
            }
            const L = Object(c.d)(t.force, t.mass);
            t instanceof g.a && t.landed ? (0 === t.thrust ? t.velocity.x += -t.velocity.x / 2 * j : t.velocity.x += z.l * L.x * j,
            t.angle = Math.PI / 8,
            t.velocity.y = 0,
            t.previous.x = t.position.x,
            t.previous.y = t.position.y,
            t.position.x += z.l * t.velocity.x * j,
            t.position.y = M.ground - 7) : t instanceof I.a && t.landed ? (t.velocity.y = 0,
            t.previous.x = t.position.x,
            t.previous.y = t.position.y,
            t.position.x += z.l * t.velocity.x * j,
            t.position.y = M.ground - t.sprite.height / 2) : t instanceof D.b && t.landed ? (t.velocity.y = 0,
            t.velocity.x += z.l * L.x * j,
            t.previous.x = t.position.x,
            t.previous.y = t.position.y,
            t.position.x += z.l * t.velocity.x * j,
            t.position.y = M.ground - t.sprite.height / 2) : (t.velocity.x += z.l * L.x * j,
            t.velocity.y += z.l * L.y * j,
            t.previous.x = t.position.x,
            t.previous.y = t.position.y,
            t.position.x += z.l * t.velocity.x * j,
            t.position.y += z.l * t.velocity.y * j),
            t.position.x + t.radius < 0 && (t.previous.x = t.position.x = M.width),
            t.position.x - t.radius > M.width && (t.previous.x = t.position.x = 0)
        }
    }
    function C(M, j) {
        const t = Object(c.h)(M.velocity)
          , L = Object(c.u)(0, M.mass * z.a)
          , i = Object(c.e)(M.forward, M.thrust)
          , N = Object(c.e)(Object(c.i)(Object(c.f)(M.velocity)), 2 ** (t - 1.2 * z.k));
        M.force = Object(c.a)(L, i, N)
    }
    function E(M, j) {
        const t = Object(c.h)(M.velocity)
          , L = Object(c.b)(M.forward, M.velocity)
          , i = Object(c.u)(0, M.mass * z.a);
        let N = Object(c.e)(M.forward, M.thrust)
          , e = Object(c.e)(M.normal, t * Object(s.i)(L, Object(c.j)(50)))
          , u = Object(c.e)(Object(c.i)(Object(c.f)(M.velocity)), 2 ** (t - z.k));
        M.position.y < j.stratosphere && (N = Object(c.g)(),
        e = Object(c.g)(),
        u = Object(c.g)()),
        M.force = Object(c.a)(i, N, e, u)
    }
    function d(M) {
        const j = Object(c.h)(M.velocity)
          , t = Object(c.u)(0, M.mass * z.a);
        let L = Object(c.e)(Object(c.i)(Object(c.f)(M.velocity)), 2 ** (j - z.k));
        M.landed && (L = Object(c.u)(-M.velocity.x, 0)),
        M.parachute && (L = Object(c.e)(Object(c.i)(Object(c.f)(M.velocity)), j / 4),
        M.updateParachute()),
        M.force = Object(c.a)(t, L)
    }
    function m(M) {
        const j = Object(c.h)(M.velocity)
          , t = Object(c.u)(0, M.mass * z.a);
        let L = Object(c.e)(Object(c.i)(Object(c.f)(M.velocity)), j / 4);
        M.force = Object(c.a)(t, L)
    }
    function h(M) {
        const j = Object(c.u)(0, M.mass * z.a);
        M.force = Object(c.a)(j)
    }
    function U(M, j) {
        M.force = Object(c.u)(0, M.mass * z.a),
        M.running ? M.velocity.x = M.direction == I.b.Right ? 10 : -10 : M.velocity.x = 0
    }
    function b(M, j, t, e, u) {
        let I, a = 0, D = Object(s.h)(), g = 1 / 60;
        return function y() {
...
, function(M, j, t) {
    ...
    function c(M, j, t={}) {
        let N = Object.assign(Object.assign({}, n), t)
          , I = []
          , c = [];
        const r = (M, j) => {
        ...
        return S(L.c, () => {
            ...
            if (y) {
                ...
                for (let t of M.barns)
                    (!j || Math.abs(j.position.x - y.position.x) > Math.abs(t.position.x - y.position.x)) && (j = t);
                y.landed && j && (y.position.x < j.position.x ? (y.velocity.x = 10,
                Math.random() < .02 && w(y)) : y.position.x > j.position.x ? (y.velocity.x = -10,
                Math.random() < .02 && w(y)) : y.velocity.x = 0)
            }
            const n = j.hasPlane();
            if (n) {
                if (1 == n.life && M.barns.size > 0) {
                    ...
                    Math.random() < .03 && (L < 1300 ? Object(i.b)(M, j) : j.target = t)
                }
                if (void 0 !== j.target)
                    if (M.has(j.target)) {
                        let t = Object(D.d)(n.position, j.target.position, M);
                        j.target instanceof e.a && (t = Object(g.c)(t),
                        t.y -= 300);
                        const L = Object(g.b)(Object(g.t)(t, n.position), n.forward)
                          , I = Object(g.s)(n.position, t);
                        if (Math.abs(L) > g.m && s(Math.sign(L) > 0 ? 1 : -1),
                        j.target instanceof e.a)
                            return;
                        if (j.target instanceof a.a && L < g.o && I < 500 && Math.random() < N.missileChance && l(),
                        L < g.n && I < 400) {
                            let t = A(M, n, g.p);
                            t instanceof u.a && t.source === n && t.thrust > 0 || T(t, j.team) || Object(i.d)(M, n)
                        }
                        n.ammo <= 3 && Object(i.d)(M, n),
                        j.target instanceof u.a && 0 === j.target.thrust && x()
                    } else
                        x();
                else {
                    let i = o(M, n, M => T(M, j.team));
                    if (i) {
                        const M = Object(g.b)(Object(g.t)(i.position, n.position), n.forward)
                          , t = Object(g.s)(n.position, i.position);
                        (Math.abs(M) < g.l && t < 1e3 || t < 350) && (j.target = i)
                    }
                    if ((null === (L = null === (t = j.team) || void 0 === t ? void 0 : t.leader) || void 0 === L ? void 0 : L.object) && (null === (I = j.team) || void 0 === I ? void 0 : I.leader) !== j) {
                        ...
                        L = Object(D.d)(n.position, L, M);
                        const i = Object(g.b)(Object(g.t)(L, n.position), n.forward);
                        s(Math.sign(i) > 0 ? 1 : -1)
                    }
                }
            }
        ...
        S(2 * L.m, () => {
            ...
            let i = S(L.c, () => {
                if (void 0 !== j.target) {
                    let L = o(M, t, M => T(M, j.team));
                    if (L) {
                        const M = Object(g.b)(Object(g.t)(L.position, t.position), t.forward)
                          , i = Object(g.s)(t.position, L.position)
                          , N = Object(g.s)(t.position, j.target.position);
                        (Math.abs(M) < g.n && i < N || i < 300) && (j.target = L)
                    }
                }
            }
            );
            r(L.m, () => clearInterval(i))
        }
        ),
        S(10 * L.m, () => {
            var t, L, i;
            if (j.hasPlane() && (!(null === (L = null === (t = j.team) || void 0 === t ? void 0 : t.leader) || void 0 === L ? void 0 : L.hasPlane()) || (null === (i = j.team) || void 0 === i ? void 0 : i.leader) === j) && void 0 === j.target) {
                if (j.object instanceof y.a)
                    return;
                let t = o(M, j.object, M => T(M, j.team), M.width);
                t && (j.target = t)
            }
        }
        ),
        S(5 * L.m, () => {
            ...
            if (!j.object)
                return;
            let e = j.object;
            if ((void 0 === (null === (i = null === (t = j.team) || void 0 === t ? void 0 : t.leader) || void 0 === i ? void 0 : i.object) || (null === (N = j.team) || void 0 === N ? void 0 : N.leader) === j) && void 0 === j.target) {
        ...
        S(30, () => {
            const t = j.hasPlane();
            t && (Object(g.a)(t.position, Object(g.e)(t.velocity, 4)).y > M.ground && (s(Math.sign(t.forward.x) > 0 ? -1 : 1),
            clearTimeout(O),
            O = r(200, () => t.elevator = 0)),
            t.position.y > M.ground - 30 && (s(Math.sign(t.forward.x) > 0 ? -1 : 1),
            clearTimeout(C),
            C = r(200, () => t.elevator = 0)),
            t.landed && (t.elevator = 0,
            t.thrust = L.j,
            z && (z = !1,
            r(L.m, () => z = !0))),
            0 === t.thrust && (t.thrust = L.j))
        }
        ),
        function() {
            for (let M of I)
    ...
    function o(M, j, t, L=2e3) {
        let i;
        if (void 0 !== j) {
            for (let N of M)
                if (N !== j && !(N instanceof u.a && N.source === j) && !t(N) && (N instanceof a.a || N instanceof I.b || N instanceof u.a && N.target === j && N.thrust > 0)) {
                    const M = Object(g.s)(j.position, N.position);
                    M < L && (i = N,
                    L = M)
                }
            return i
    ...
    function A(M, j, t=g.n, L=500, i=(M => M instanceof N.a)) {
        let e, u = L;
        for (let L of M) {
            if (L === j)
                continue;
            ...
            const M = Object(g.s)(j.position, L.position)
              , N = Object(g.b)(Object(g.t)(L.position, j.position), j.forward);
            M < u && Math.abs(N) < t && (e = L,
            u = M)
        }
        return e
    }
    function T(M, j) {
        return void 0 !== j && (!!(M instanceof a.a && M.player && M.player.team === j) || (!!(M instanceof a.a && M.team && M.team === j) || (!!(M instanceof u.a && M.source.player && M.source.player.team === j) || !!(M instanceof I.b && M.player && M.player.team === j))))
    }
}
, function(M, j, t) {
    "use strict";
    var L = t(3);
    j.a = Object(L.f)(["3-D Man", "A-Bomb", "A.I.M.", "Aaron Stack", "Abbey", "Abomination", "Absorbing Man", "Abyss", "Acolytes", "Adam Destine", "Adam Warlock", "Adrienne", "Aegis", "Agent", "Agent Brand", "Agent Liberty", "Agent X", "Agent Zero", "Agents of Atlas", "Aginar", "Ahab", "Air-Walker", "Ajak", "Ajaxis", "Akemi", "Alain", "Albert Cleary", "Albion", "Aleta", "Alex Power", "Alex Wilder", "Alexa Mendez", "Alexander Pierce", "Alice", "Alicia Masters", "Alisha", "Alpha Flight", "Alvin Maker", "Amadeus Cho", "Amanda", "Amanda Sefton", "Amazi-Girl", "Amazoness", "Amber", "American Eagle", "Amethyst", "Amiko", "Amora", "Amphibian", "Amun", "Ancient One", "Andrew Chord", "Andromeda", "Angel", "Angela", "Anita Blake", "Anne Marie Hoag", "Annihilus", "Anole", "Ant-Man", "Anthem", "Anya", "Apocalypse", "Aquagirl", "Aquaman", "Aqueduct", "Arachne", "Arcade", "Arcana", "Archangel", "Arclight", "Ares", "Argent", "Arisia", "Armadillo", "Armor", "Armory", "Arnim Zola", "Arrowette", "Arsenal", "Arsenic", "Artemis", "Artiee", "Asgardian", "Askew-Tronics", "Aspen", "Asterix", "Asylum", "Atlas", "Atom", "Atomic", "Aurora", "Avalanche", "Avalon", "Avengelyne", "Avengers", "Azazel", "Azrael", "Aztec", "B.Orchid", "Babaing", "Ballistic", "Bane", "Banshee", "Barb", "Barbarella", "Baron Strucker", "Baron Zemo", "Baroness", "Baroness S'Bak", "Barracuda", "Bart Rozum", "Bastion", "Batgirl", "Batman", "Batroc the Leaper", "Battering Ram", "Battle", "Batwoman", "Baxter Stockman", "Bazooka", "Beach Head", "Beak", "Beast", "Beautiful", "Bebop", "Becatron", "Bedlam", "Beef", "Beetle", "Bella", "Belphegor", "Ben Grimm", "Ben Parker", "Ben Reilly", "Ben Urich", "Bengal", "Beta-Ray Bill", "Bette", "Betty Brant", "Betty Ross", "Beyonder", "Bi-Beast", "Big", "Big Bertha", "Big Wheel", "Bill Hollister", "Binary", "Bionic Commando", "Bishop", "Bizarro", "Black", "Black Bird", "Black Bolt", "Black Canary", "Black Cat", "Black Crow", "Black Knight", "Black Panther", "Black Queen", "Black Tarantula", "Black Tom", "Black Widow", "Blackbat", "Blackhawks", "Blackheart", "Blacklash", "Blacklight", "Blackout", "Blade", "Blastaar", "Blazing Skull", "Blindfold", "Blink", "Blitzkrieg", "Blizzard", "Blob", "Blockbuster", "Blok", "Bloke", "Blonde", "Blonde Phantom", "Blood Wraith", "Bloodaxe", "Bloodberry", "Bloodscream", "Bloodstorm", "Bloodstrike", "Bloom", "Blossom", "Blue", "Blue Beetle", "Blue Blade", "Blue Marvel", "Blue Shield", "Bluestreak", "Blur", "Bonnie", "Bonnie King", "Boodikka", "Boom", "Boom Boom", "Boomer", "Boomerang", "Booster", "Bounty", "Box", "Brainiac", "Brandy", "Bride of Nine Spiders", "Brittany", "Bromley", "Bronze", "Bronze Tiger", "Brood", "Brother Voodoo", "Bruce", "Bruce Banner", "Brute", "Bubbles", "Bucky", "Buff", "Buffy", "Bug", "Bulldozer", "Bulleteer", "Bulletgirl", "Bullseye", "Bumblebee", "Burka", "Burnout", "Bushwacker", "Buttercup", "Butterfly", "Cable", "Calamity", "Calendar", "Caliban", "Callisto", "Calypso", "Cammi", "Cammy", "Cannonball", "Cap'n Oz", "Captain", "Captain America", "Captain Britain", "Captain Cross", "Captain Flint", "Captain Marvel", "Captain Midlands", "Captain Planet", "Captain Stacy", "Captain Universe", "Cardiac", "Caretaker", "Cargill", "Carlie Cooper", "Carmella Unuscione", "Carnage", "Carol Danvers", "Carol Hines", "Cassandra", "Cassandra Nova", "Cat", "Catseye", "Catwoman", "Cecilia", "Cecilia Reyes", "Celestials", "Celsius", "Centennial", "Centurions", "Cerebro", "Cerise", "Cesspool", "Ch'od", "Chamber", "Chameleon", "Champions", "Chance", "Chandika", "Changeling", "Charles Xavier", "Charlie Campion", "Chase", "Chase Stein", "Chastity", "Chat", "Cheetah", "Cheetara", "Cherry", "Chimera", "Choice", "Chores MacGillicudy", "Christian Walker", "Chronomancer", "Chun-Li", "Cimarron", "Cinnamon", "Circuit", "Cissie King-Jones", "Clan Destine", "ClanDestine", "Clea", "Cleopatra", "Clint Barton", "Cloak", "Cloak and Dagger", "Clobber", "Clobberella", "Cloud 9", "Clover", "Coagula", "Cobalt Man", "Cobra", "Cobweb", "Colleen", "Colleen Wing", "Colonel America", "Colossus", "Colt", "Comedian", "Comet", "Conan the Barbarian", "Connor Hawke", "Constrictor", "Contessa", "Controller", "Copperhead", "Copycat", "Cornelius", "Corsair", "Cosmo", "Cottonmouth", "Count Nefaria", "Countess", "Crane", "Crazy", "Crimson", "Crimson Avenger", "Crimson Crusader", "Crimson Dynamo", "Crimson King", "Crossbones", "Crule", "Crusher Hogan", "Crystal", "Cuckoo", "Curt Conners", "Cuthbert", "Cyber", "Cybergirl", "Cybersix", "Cyblade", "Cyborg", "Cyclone", "Cyclops", "Cypher", "D'Ken Neramani", "Dagger", "Daily Bugle", "Daimon Hellstrom", "Daken", "Dakota North", "Damage Control", "Damian", "Dani Moonstar", "Danny Rand", "Daredevil", "Dargo Ktor", "Dark Avengers", "Dark Beast", "Dark Phoenix", "Dark X-Men", "Darkhawk", "Darkstar", "Darna", "Dart", "Darwin", "David Alleyne", "Dawn", "Dawnstar", "Dazzler", "Deacon Frost", "Dead", "Dead Girl", "Deadpool", "Death", "Deathbird", "Deathcry", "Deathlok", "Deathstrike", "Debra Whitman", "Debrii", "Decepticon", "Deena Pilgrim", "Deep", "Defenders", "Demogoblin", "Destiny", "Detective Soap", "Devastator", "Devi", "Deviants", "Devil Dinosaur", "Devos", "Dexter Bennett", "Diablo", "Diamond", "Diamondback", "Dick", "Dinah Soar", "Dirk Anger", "Diva", "Doc Samson", "Doc Savage", "Doctor", "Doctor Doom", "Doctor Faustus", "Doctor Mindbender", "Doctor Octopus", "Doctor Spectrum", "Doctor Strange", "Dog Brother #1", "Doll", "Dollar", "Dolphin", "Domino", "Donald Blake", "Donatello", "Donna", "Doomsday", "Doomsday Man", "Doop", "Doorman", "Doppelganger", "Dorian Gray", "Dormammu", "Dorothy", "Dove", "Dr. Strange", "Dracula", "Dragon Lord", "Dragon Man", "Dragonfly", "Dragonna", "Drax", "Dreadnought", "Dreadnoughts", "Dream", "Dreaming Celestial", "Druig", "Duck-Girl", "Dum Dum Dugan", "Dumb", "Dusk", "Dust", "Dyna", "Dynamite", "Earthquake", "Echo", "Eddie Brock", "Eddie Lau", "Edwin Jarvis", "Ego", "El Aguila", "Elasti-Girl", "Elastigirl/Mrs.Incredible", "Electra", "Electro", "Elektra", "Elements of Doom", "Elite", "Elixir", "Elloe Kaifi", "Elongated", "Elsa Bloodstone", "Emma", "Emma Frost", "Empath", "Emplate", "Empowered", "Empress", "Enchantress", "Ender Wiggin", "Energizer", "Epoch", "Eradicator", "Erik the Red", "Erza", "Eternals", "Eternity", "Excalibur", "Exiles", "Exodus", "Expediter", "Ezekiel", "Ezekiel Stane", "Fabian Cortez", "Fairchild", "Faith", "Falcon", "Fallen", "Fallen One", "Famine", "Fantastic Four", "Fantastick Four", "Fantomah", "Fantomette", "Fantomex", "Fat Cobra", "Fathom", "Felicia Hardy", "Fenris", "Feral", "Fever", "Fin Fang Foom", "Fire", "Firebird", "Firebrand", "Firedrake", "Firefly", "Firelord", "Firestar", "Firestorm", "Fixer", "Flaberella", "Flamebird", "Flash", "Flatman", "Fleet Tracking", "Fleur-de-Lis", "Flint", "Flora", "Flying Dutchman", "Foggy Nelson", "Foot Soldier", "Force Works", "Forearm", "Forerunner", "Forge", "Forgotten One", "Four Horsemen of Apocalypse", "Frank Castle", "Frankenstein's Monster", "Franklin Richards", "Franklin Storm", "Freak", "Free", "Freefall", "Frenzy", "Frightful Four", "Frog Thor", "Frog-Man", "Fury", "G.I. Joe", "GW Bridge", "Gabe Jones", "Galactus", "Galia", "Galvatron", "Gambit", "Gamma Corps", "Gamora", "Gangbuster", "Ganymede", "Garganta", "Gargoyle", "Gargoyles", "Garia", "Garrison Kane", "Gateway", "Gauntlet", "Geiger", "Gemma", "Gene Sailors", "Generation X", "Genesis", "Genis-Vell", "George Stacy", "Gertrude", "Gertrude Yorkes", "Ghost", "Ghost Rider", "Giant Girl", "Giant-Man", "Gideon", "Git Hoskins", "Gladiator", "Glenn Talbot", "Glitter", "Glorian", "Glory", "Gloss", "Goblin Queen", "Godiva", "Golden Guardian", "Goliath", "Gorgon", "Gorilla Man", "Grace", "Grandmaster", "Graphics", "Gravity", "Great Lakes Avengers", "Green", "Green Arrow", "Green Goblin", "Green Lantern", "Gressill", "Grey Gargoyle", "Greymalkin", "Grim Reaper", "Groot", "Guardian", "Guardians of the Galaxy", "Guardsmen", "Guile", "Gung-Ho", "Gunslinger", "Guy", "Gwen", "Gwen Stacy", "Gypsy", "H.A.M.M.E.R.", "H.E.R.B.I.E.", "HYDRA", "Hairball", "Hal", "Half-Life", "Halo", "Hammerhead", "Hank", "Hank Pym", "Hannibal King", "Happy Hogan", "Harbinger", "Hardball", "Harley Davidson Cooper", "Harley Quinn", "Harpoon", "Harrier", "Harry Heck", "Harry Osborn", "Hate-Monger", "Haven", "Havok", "Hawk", "Hawkeye", "Hawkgirl", "Hawkman", "Hawkwoman", "Heather", "Hedge Knight", "Hellboy", "Hellcat", "Hellfire Club", "Hellion", "Hellions", "Helspont", "Hemingway", "Henry Peter Gyrich", "Hepzibah", "Hercules", "Heroes For Hire", "Hex", "High Evolutionary", "Hindsight Lad", "Hiroim", "Hit", "Hitman", "Hitomi Sakuma", "Hobgoblin", "Hobogoblin", "Holocaust", "Holy", "Homer Simpson", "Hooded", "Hope Summers", "Horridus", "Howard Saint", "Howard The Duck", "Hulk", "Hulkling", "Human Cannonball", "Human Fly", "Human Robot", "Human Target", "Human Torch", "Humbug", "Huntara", "Huntress", "Husk", "Hussar", "Hydra", "Hydro-Man", "Hyperion", "Hypno-Hustler", "Ice", "Icemaiden", "Iceman", "Ichigo", "Ikaris", "Illuminati", "Ilyana Rasputin", "Imp", "Imperfects", "Imperial Guard", "Impossible Man", "Impulse", "In-Betweener", "Incredible Hulk", "Indigo", "Inertia", "Infant Terrible", "Infragirl", "Inhumans", "Ink", "Insect", "Invaders", "Invisible", "Invisible Woman", "Iron", "Iron Cross Army", "Iron Fist", "Iron Lad", "Iron Man", "Iron Monger", "Iron Patriot", "Ironclad", "J. Jonah Jameson", "Jack Flag", "Jack Murdock", "Jack O' Lantern", "Jack Power", "Jackal", "Jackpot", "Jade", "Jake", "Jakita", "James Buchanan Barnes", "James Howlett", "Jamie Braddock", "Jane Foster", "Jann", "Jarella", "Jasper Sitwell", "Jayna", "Jazinda", "Jean", "Jean Grey", "Jem", "Jennifer", "Jennifer Smith", "Jenny", "Jericho", "Jeryn Hogarth", "Jess", "Jesse", "Jessica", "Jessica Drew", "Jessica Jones", "Jet", "Jetstream", "Jigsaw", "Jimmy Woo", "Jinx", "Joan the Mouse", "Jocasta", "John Farson", "John Jameson", "John Porter", "John Wraith", "Johnny Blaze", "Johnny Storm", "Joker", "Jolt", "Jonah", "Jonni", "Joseph", "Joshua Kane", "Josiah X", "Joystick", "Jubilee", "Judomaster", "Juggernaut", "Jule Carpenter", "Julian Keller", "Jungle", "Juniper", "Junta", "Justice", "Justin Hammer", "KOS-MOS", "Ka-Zar", "Kabuki", "Kamandi", "Kang", "Kaoru", "Karate", "Karate Kid", "Karatecha", "Karen O'Malley", "Karen Page", "Karma", "Karnak", "Karolina", "Karolina Dean", "Kasumi", "Kat Farrell", "Katana", "Kate", "Kate Bishop", "Katie Power", "Katma", "Kelly", "Ken Ellis", "Kendra", "Khan", "Kid", "Kid Colt", "Killer Shrike", "Killmonger", "Killraven", "Kim", "Kimberly", "Kinetix", "King Bedlam", "King Cobra", "Kingpin", "Kinsey Walden", "Kismet", "Kitty", "Kitty Pryde", "Klaw", "Knockout", "Kole", "Komodo", "Korath", "Korg", "Korvac", "Kratha", "Kraven", "Kraven the Hunter", "Kree", "Krista Starr", "Kristin", "Kronos", "Krystala", "Kulan Gath", "Kumori", "Kyle", "Kylun", "La", "La Nuit", "Lady", "Lady Bullseye", "Lady Deathstrike", "Lady Mastermind", "Lady Shiva", "Lady Ursula", "Lady Vermin", "Ladyhawk", "Lagoon", "Lake", "Lamprey", "Landau", "Lanolin", "Laurel", "Lava-Man", "Lavagirl", "Layla", "Layla Miller", "Leader", "Leatherhead", "Leatherneck", "Leech", "Leeloo", "Legion", "Lenny Balinger", "Lenore", "Leo", "Leonardo", "Leopardon", "Leper Queen", "Lester", "Lethal Legion", "Lettuce", "Liberty", "Lieutenant Marcus Stone", "Lifeguard", "Lightning", "Lightning Lords of Nepal", "Lightspeed", "Lila Cheney", "Lilandra", "Lilith", "Lily Hollister", "Lime", "Lionheart", "Little", "Living Lightning", "Living Mummy", "Living Tribunal", "Liz", "Liz Osborn", "Lizard", "Loa", "Lobo", "Lockheed", "Lockjaw", "Logan", "Loki", "Loners", "Longshot", "Looker", "Lord Hawal", "Lord Tyger", "Lords of Avalon", "Loria", "Lorna Dane", "Luckman", "Lucky Pierre", "Lucy in the Sky", "Luke Cage", "Luminals", "Lyja", "Lynn", "M.O.D.A.M.", "M.O.D.O.G.", "M.O.D.O.K.", "Ma Gnuci", "Mac Gargan", "Mach IV", "Machine Man", "Mad Thinker", "Madame", "Madame Hydra", "Madame Masque", "Madame Web", "Maddog", "Madelyne Pryor", "Madripoor", "Madrox", "Maelstrom", "Maestro", "Magdalene", "Maggott", "Magik", "Maginty", "Magma", "Magneto", "Magus", "Maiden", "Major Mapleleaf", "Makkari", "Malcolm Colcord", "Malice", "Man-Thing", "Man-Wolf", "Mandarin", "Mandrill", "Mandroid", "Manhattan Guardian", "Manhunter", "Manitou", "Manta", "Mantis", "Marauders", "Marcus Van Sciver", "Maria Hill", "Mariko Yashida", "Marionette", "Marrina", "Marrow", "Marten Broadcloak", "Martian", "Martin Li", "Marvel", "Marvel Apes", "Marvel Boy", "Marvel Zombies", "Marvelman", "Marvex", "Mary", "Mary Jane Watson", "Mas", "Masada", "Masked Marvel", "Masque", "Master Chief", "Master Mold", "Mastermind", "Masters of Evil", "Mathemanic", "Matilda", "Matsu'o Tsurayaba", "Matthew Murdock", "Mattie Franklin", "Mauler", "Maverick", "Max", "Maxima", "Maximum", "Maximus", "May Parker", "Maya", "Medusa", "Mega Man", "Megatron", "Meggan", "Melaka", "Meltdown", "Menace", "Mentallo", "Mentor", "Mephisto", "Mephistopheles", "Mera", "Mercer", "Mercury", "Merry", "Mesmero", "Metal Master", "Metamorpho", "Meteorite", "Mia Dearden", "Michael Van Patrick", "Michaelangelo", "Micro/Macro", "Microbe", "Microchip", "Micromax", "Midnight", "Miek", "Mighty", "Mikhail Rasputin", "Millenium Guard", "Millie the Model", "Mimic", "Mindworm", "Mint", "Miracleman", "Mirage", "Misfit", "Miss", "Miss America", "Mister Fantastic", "Mister Fear", "Mister Freeze", "Mister Hyde", "Mister Sinister", "Misty", "Misty Knight", "Miyako", "Mockingbird", "Moira MacTaggert", "Mojo", "Mole Man", "Molecule Man", "Molly", "Molly Hayes", "Molly Von Richtofen", "Molten Man", "Momoko", "Mondo Gecko", "Mongoose", "Mongu", "Monster Badoon", "Monstress", "Moon Knight", "Moondragon", "Moonstar", "Moonstone", "Morbius", "Mordo", "Morg", "Morgan Stark", "Morlocks", "Morlun", "Morph", "Moth", "Mother Askani", "Mother-One", "Motormouth", "Mr. Bumpo", "Mr. Fantastic", "Mr. Fish", "Mr. Fixit", "Mr. Hyde", "Mr. Immortal", "Mr. Meugniot", "Mr. Negative", "Mr. Payback", "Mr. X", "Ms. Marvel", "Mulholland Black", "Multiple Man", "Musa", "Muskrat", "Mysterio", "Mystique", "Namor", "Namora", "Namorita", "Naoko", "Napoleon Bonafrog", "Natasha", "Natasha Romanoff", "Nayana", "Nebula", "Negative", "Nehzno", "Nekra", "Nelvana", "Nemesis", "Neon", "Network", "New Goblin", "New Mutants", "New Warriors", "New X-Men", "Newton Destine", "Next Avengers", "Nextwave", "Nick Fury", "Nico", "Nico Minoru", "Nicolaos", "Night", "Night Nurse", "Night Thrasher", "Nightcat", "Nightcrawler", "Nighthawk", "Nightmare", "Nightshade", "Nightstar", "Nightveil", "Nightwing", "Nikita", "Nikki", "Nimrod", "Niobe", "Nite", "Nite Owl", "Nitro", "Nocturne", "Nomad", "Norman Osborn", "Norrin Radd", "Northstar", "Nova", "Nuke", "Obadiah Stane", "Octobriana", "Odin", "Ogun", "Old Lace", "Omega Flight", "Omega Red", "Omega Sentinel", "Omega the Unknown", "Onslaught", "Onyx", "Oracle", "Ord", "Orion", "Orphan", "Orphan-Maker", "Otto Octavius", "Outlaw Kid", "Overlord", "Owl", "Owlman", "Owlwoman", "Ozymandias", "Paibok", "Paladin", "Panda Khan", "Pandemic", "Pantha", "PantyMan", "Paper Doll", "Parasite", "Patch", "Patriot", "Payback", "Penance", "Penguin", "Pepper Potts", "Pestilence", "Pet Avengers", "Pete Wisdom", "Peter Parker", "Peter Quill", "Phalanx", "Phantom", "Phantom Reporter", "Phil Sheldon", "Phoenix", "Photon", "Phyla-Vell", "Piledriver", "Pilgrim", "Pink", "Pip", "Pixie", "Plastic", "Plazm", "Poison", "Poison Ivy", "Polaris", "Post", "Power", "Power Man", "Power Pack", "Praxagora", "Preak", "Pretty Boy", "Pride", "Prima", "Prince of Orphans", "Princess", "Princess Powerful", "Prism", "Prodigy", "Proemial Gods", "Professor Monster", "Professor X", "Promethea", "Proteus", "Proudstar", "Prowler", "PsyNapse", "Psyche-Out", "Psycho-Man", "Psylocke", "Psynch", "Puck", "Pudding", "Puff Adder", "Puma", "Punisher", "Puppet Master", "Purifiers", "Purple Man", "Pyro", "Quasar", "Quasimodo", "Queen", "Queen Noir", "Quentin Quire", "Quicksilver", "Rachel Grey", "Rad", "Radioactive Man", "Rafael Vega", "Rage", "Raider", "Rainbow", "Rainmaker", "Rampage", "Randall", "Randall Flagg", "Random", "Raphael", "Raptor", "Rapture", "Rat King", "Rattler", "Ravage 2099", "Raven", "Ravenous", "Rawhide Kid", "Ray", "Ray Fillet", "Raza", "Reaper", "Reavers", "Red", "Red 9", "Red Ghost", "Red Hulk", "Red She-Hulk", "Red Shift", "Red Skull", "Red Wolf", "Redwing", "Reptil", "Rescue", "Retro Girl", "Revanche", "Reverse", "Rhea", "Rhino", "Rhodey", "Richard Dragon", "Richard Fisk", "Rick Jones", "Ricochet", "Rictor", "Riddler", "Riptide", "Risque", "River", "Roadblock", "Robbie Robertson", "Robert Baldwin", "Robin", "Robin Chapel", "Robin Hood", "Rocket", "Rocket Raccoon", "Rocket Racer", "Rockslide", "Rogue", "Roland Deschain", "Romulus", "Ronan", "Ronin", "Rorschach", "Rose", "Rouge", "Roughhouse", "Roulette", "Roxanne Simpson", "Roxy", "Rumble", "Rumiko Fujikawa", "Runaways", "Russian", "S.H.I.E.L.D.", "S.T.R.I.P.E.", "Sabra", "Sabretooth", "Sage", "Sailor", "Sakura", "Salacious Crumb", "Salem's Seven", "Sally Floyd", "Salo", "Samantha", "Samus", "Sandman", "Santa Claus", "Sara", "Saracen", "Sasquatch", "Satana", "Saturn", "Sauron", "Savage Land", "Savant", "Scalphunter", "Scarecrow", "Scarlet", "Scarlet Spider", "Scarlet Witch", "Scorpion", "Scourge", "Scourge of the Underworld", "Scrambler", "Scream", "Screwball", "Sebastian Shaw", "Secret", "Secret Warriors", "Selene", "Senator Kelly", "Sentinel", "Sentinels", "Sentry", "Sepulchre", "Ser Duncan", "Serpent Society", "Serpentor", "Sersi", "Shadow", "Shadow King", "Shadowcat", "Shadoweyes", "Shadu the Shady", "Shakti", "Shalla-bal", "Shaman", "Shamrock", "Shane Yamada-Jones", "Shang-Chi", "Shanna", "Shanna the She-Devil", "Shape", "Shard", "Sharon Carter", "Sharon Ventura", "Shatterstar", "Shazam", "She-Dragon", "She-Hulk", "She-Ra", "She-Thing", "She-Venom", "SheZow", "Sheena", "Shen", "Sheva Callister", "Shi", "Shi'Ar", "Shikari", "Shining", "Shinko Yamashiro", "Shinobi Shaw", "Shiva", "Shiver Man", "Shocker", "Shockwave", "Shooting Star", "Shotgun", "Shredder", "Shriek", "Shrinking", "Siege", "Sif", "Silhouette", "Silk", "Silk Fever", "Silver", "Silver Centurion", "Silver Fox", "Silver Sable", "Silver Samurai", "Silver Surfer", "Silverclaw", "Silvermane", "Sin", "Sinann", "Sinister Six", "Sir Ram", "Siren", "Siryn", "Sister Grimm", "Skaar", "Skids", "Skin", "Skreet", "Skrulls", "Skullbuster", "Skyrocket", "Slapstick", "Slayback", "Sleeper", "Sleepwalker", "Slipstream", "Slyde", "Smasher", "Smiling Tiger", "Snake-Eyes", "Snowbird", "Solo", "Songbird", "Sons of the Tiger", "Spacker Dave", "Spartan", "Sparx", "Spawn", "Spectrum", "Speed", "Speed Demon", "Speedball", "Speedy", "Spellbinder", "Spencer Smythe", "Sphinx", "Spider", "Spider-Girl", "Spider-Ham", "Spider-Man", "Spider-Woman", "Spiral", "Spirit", "Spitfire", "Spoiler", "Spot", "Sprite", "Spy", "Spyke", "Squadron Sinister", "Squadron Supreme", "Squirrel", "Squirrel Girl", "Stacy", "Stacy X", "Star Brand", "Star-Lord", "Star-Spangled", "Starbolt", "Stardust", "Starfire", "Starfox", "Stargirl", "Starhawk", "Starjammers", "Stark Industries", "Starwoman", "Stature", "Steel", "Steel Serpent", "Stella", "Stellaris", "Stepford", "Stepford Cuckoos", "Stephanie", "Stephanie de la Spiroza", "Stephen Strange", "Steve Rogers", "Stick", "Stilt-Man", "Stinger", "Stingray", "Stone Men", "Storm", "Stormtrooper", "Stranger", "Stripperella", "Strong Guy", "Stryfe", "Stunner", "Sub-Mariner", "Sue Storm", "Sugar Man", "Sumo", "Sun", "Sunfire", "Sunset Bain", "Sunspot", "Super Hero Squad", "Super-Adaptoid", "Super-Skrull", "Supergirl", "Supergran", "Superman", "Supernaut", "Superwoman", "Suprema", "Supreme Intelligence", "Surge", "Susan Delgado", "Swarm", "Sway", "Swift", "Switch", "Swordsman", "Sydney", "Sym", "Synch", "T'Challa", "Tag", "Talisman", "Talkback", "Talon", "Talos", "Tana Nile", "Tank", "Tara", "Tarantula", "Tarot", "Taskmaster", "Tattoo", "Tecna", "Ted Forrester", "Teenage Mutant Ninja Turtles", "Tempest", "Tempo", "Tenebrous", "Terra", "Terrax", "Terror", "Terry", "Texas Twister", "Thaddeus Ross", "Thanos", "The 198", "The Anarchist", "The Avengers", "The Call", "The Captain", "The Defenders", "The Enforcers", "The Executioner", "The Fallen", "The Fury", "The Hand", "The Hood", "The Howling Commandos", "The Hunter", "The Initiative", "The Leader", "The Liberteens", "The Liberty Legion", "The Order", "The Phantom", "The Professor", "The Punisher", "The Question", "The Renegades", "The Rocketeer", "The Santerians", "The Shadow", "The Shiver Man", "The Spike", "The Stranger", "The Twelve", "The Wasp", "The Watchers", "Thena", "Thing", "Thor", "Thor Girl", "Thunder", "Thunderball", "Thunderbird", "Thunderbolt", "Thunderbolt Ross", "Thunderbolts", "Thundra", "Tick", "Tiger", "Tiger Shark", "Tiger's Beautiful Daughter", "Tigra", "Tim", "Timeslip", "Tinkerer", "Titaness", "Titania", "Titanium Man", "Toad", "Toad Men", "Tomas", "Tombstone", "Tomorrow Man", "Tony Stark", "Topaz", "Toro", "Toxin", "Traci", "Trauma", "Triathlon", "Triceraton", "Trini", "Triplicate", "Trish Tilby", "Triton", "Troia", "True Believers", "Tsunami", "Turbo", "Tusk", "Two-Face", "Two-Gun Kid", "Tyger Tiger", "Typhoid Mary", "Tyrannus", "Tyrant", "U-Foes", "U-Go Girl", "U.S. Agent", "Uatu The Watcher", "Ulik", "Ultimate Spider-Man", "Ultimates", "Ultimatum", "Ultimo", "Ultra", "Ultra-Adaptoid", "Ultragirl", "Ultravioletrrr", "Ultrawoman", "Ultron", "Umar", "Unicorn", "Union Jack", "Unknown Soldier", "Unus", "Valda", "Valeria Richards", "Valis", "Valkyrie", "Vampirella", "Vampiro", "Vance Astro", "Vanisher", "Vapor", "Varga", "Vargas", "Vector", "Veda", "Velocity", "Vengeance", "Venom", "Venus", "Venus Dee Milo", "Vera", "Vermin", "Vertigo", "Victor Mancha", "Victor Von Doom", "Vigilante", "Vin Gonzales", "Vindicator", "Violations", "Violator", "Violet", "Viper", "Virginia Dare", "Virtuous", "Vision", "Vivisector", "Vixen", "Vogue", "Void", "Voodoo", "Vulcan", "Vulture", "W.I.T.C.H:", "Wallflower", "Wallop", "Wallow", "War", "War Machine", "Warbird", "Warbound", "Warhawk", "Warlock", "Warpath", "Warren Worthington III", "Warstar", "Wasp", "Watchmen", "Weapon Omega", "Weapon X", "Web", "Wendell Rand", "Wendell Vaughn", "Wendigo", "Wendy", "Werewolf By Night", "Whiplash", "WhirlGirl", "Whirlwind", "Whistler", "White Queen", "White Tiger", "Whizzer", "Wiccan", "Widget", "Wild", "Wild Child", "Wild Pack", "Wildcat", "Wildside", "William Stryker", "Willow", "Wilson Fisk", "Wind", "Wind Dancer", "Winged", "Winter Soldier", "Witchblade", "Witchfire", "Wither", "Wolf Cub", "Wolfpack", "Wolfsbane", "Wolverine", "Wonder", "Wonder Man", "Wonder Woman", "Wong", "Word", "Wraith", "Wrecker", "Wrecking Crew", "Wyatt Wingfoot", "X-23", "X-51", "X-Babies", "X-Cutioner", "X-Cutioner's Song", "X-Factor", "X-Factor Investigations", "X-Force", "X-Man", "X-Men", "X-Ray", "X-Statix", "X.S.E.", "XJ-9", "XS", "Xavin", "Xena", "Xera", "Xi’an", "Xorn", "Yellow", "Yellow Claw", "Yellowjacket", "Young Avengers", "Young X-Men", "Zakuro", "Zaladane", "Zaran", "Zarda", "Zarek", "Zatanna", "Zatara", "Zealot", "Zeigeist", "Zemo", "Zodiak", "Zombie", "Zuras", "Zzzax"])
}
, function(M, j, t) {
    "use strict";
    t.d(j, "a", (function() {
    ...
    var L = t(3);
    const i = ["#f36a20", "#dbaf02", "#70ba01", "#49da9a", "#34bbe6", "#4380db", "#261fe6", "#d23be7", "#ff0786", "#ff7d78", "#ff9c0a", "#ffcc00", "#a8c545", "#00a885", "#6a4c93", "#8e44ad", "#2c3e50", "#f39c12", "#d35400", "#c0392b", "#2980b9", "#16a085", "#27ae60", "#8e44ad", "#244b8c", "#f39c12", "#d35400", "#c0392b"]
...
, function(M, j, t) {
    ...
    var L = t(7)
      ...
      , I = t(3)
      , a = t(0);
    function D(M, j, t, D, n) {
        var c;
        let o = t.stratosphere - j.offsetY;
        o < 0 ? o = 0 : (M.fillStyle = "#1f4752",
        M.fillRect(0, 0, j.width, o)),
        M.fillStyle = "#9be2fe",
        M.fillRect(0, o, j.width, j.height),
        function(M, j, t) {
            if (t.stratosphere > j.offsetY) {
                let L = 900;
                const i = -j.offsetY - L + t.stratosphere + 4;
                M.save(),
                M.translate(0, i);
                let N = M.createLinearGradient(0, 0, 0, L);
        ...
        g(M, j, t, u.b.forest2, 1.05, 50),
        g(M, j, t, u.b.forest, 1.02, 100),
        function(M, j, t) {
            for (let L of t.groundObjects) {
                const t = L.position.x - j.offsetX
                  , i = L.position.y - j.offsetY;
                t + L.sprite.width < 0 || t - L.sprite.width > j.width || (M.save(),
                M.translate(t, i),
                L.sprite.draw(M),
                M.restore())
            }
        ...
        function(M, j, t) {
            const L = t.height - j.offsetY - u.b.ground.height;
            if (L < j.height) {
                M.save(),
                M.translate(-j.offsetX % u.b.ground.width, L);
                let t = Math.floor(j.width * j.cameraScale / u.b.ground.width) + 1;
                for (; t-- > 0; )
                    u.b.ground.draw(M),
                    M.translate(u.b.ground.width - 1, 0);
                M.restore()
            }
        }(M, j, t),
        function(M, j, t) {
        ...
        for (let e of t) {
            const t = e.getX(D) - j.offsetX
              , I = e.getY(D) - j.offsetY;
            if (!(t + e.radius < 0 || t - e.radius > j.width)) {
                if (M.save(),
                I + e.radius < 0)
                    (e instanceof N.a || e instanceof i.a) && (M.translate(Math.floor(t), 3),
                    u.b.pointerUp.drawMiddle(M));
                else if (I - e.radius > j.height)
                    (e instanceof N.a || e instanceof i.a) && (M.translate(Math.floor(t), j.height - 3),
                    u.b.pointerDown.drawMiddle(M));
                else {
                    if (M.translate(t, I),
                    M.rotate(e.angle),
                    e instanceof L.a ? e.draw(M) : e.sprite.drawMiddle(M),
                    window.showCircles) {
                        for (let {v: j, r: t} of e.circles)
                            M.beginPath(),
                            M.fillStyle = "rgba(255,45,247,0.5)",
                            M.arc(j.x, j.y, t, 0, 2 * Math.PI),
                            M.fill();
                        M.beginPath(),
                        M.arc(0, 0, e.radius, 0, 2 * Math.PI),
                        M.stroke()
                    }
                    if (window.showVectors && (M.save(),
                    M.rotate(-e.angle),
                    M.beginPath(),
                    M.moveTo(0, 0),
                    ...
                    M.stroke(),
                    M.restore()),
                    e instanceof i.a && e.thrust > 0 && (M.translate(10, 0),
                    u.b.missileFire[Math.random() < .5 ? 0 : 1].drawMiddle(M)),
                    window.showTarget && e instanceof N.a && void 0 !== (null === (c = e.player) || void 0 === c ? void 0 : c.target)) {
                        M.save(),
                        M.rotate(-e.angle);
                        let j = Object(a.t)(e.player.target.position, e.position);
                        j = Object(a.t)(j, Object(a.e)(Object(a.i)(j), e.player.target.radius)),
                    ...
                    if (e instanceof N.a && void 0 !== e.pointTo) {
                        M.save(),
                        M.rotate(-e.angle);
                        let j = Object(a.t)(e.pointTo.position, e.position);
                        j = Object(a.t)(j, Object(a.e)(Object(a.i)(j), e.pointTo.radius)),
        ...
        for (let L of t.particles) {
            ...
            M.save(),
            M.translate(t, i),
            L instanceof e.f ? (M.rotate(L.angle),
            M.globalAlpha = L.opacity,
            M.scale(L.scale, L.scale),
            L.sprite.drawMiddle(M)) : L instanceof e.a ? L.sprites[L.frame].drawMiddle(M) : L instanceof e.b ? L.sprite.drawMiddle(M) : L instanceof e.c ? (M.globalAlpha = 1 - Math.min(1, Math.abs((Object(I.h)() - L.createdAt) / L.duration)),
            L.sprite.drawMiddle(M)) : (M.fillStyle = L.color,
            M.fillRect(0, 0, L.size, L.size)),
            M.restore()
        }
        n(M)
    }
    function g(M, j, t, L, i, N) {
        const e = t.height - j.offsetY - L.height + N;
        if (e < j.height) {
            M.save(),
            M.globalAlpha = .4,
            M.translate(-j.offsetX / i % L.width, e);
            let t = Math.floor(j.width / L.width + 2);
            for (; t-- > 0; )
                L.draw(M),
                M.translate(L.width, 0);
            M.restore()
        }
    }
    function y(M, j, t, L, i) {
        M.beginPath();
        const N = L - j
          , e = i - t
          , u = Math.atan2(e, N);
        M.moveTo(j, t),
        M.lineTo(L, i),
        M.lineTo(L - 10 * Math.cos(u - Math.PI / 6), i - 10 * Math.sin(u - Math.PI / 6)),
        M.moveTo(L, i),
        M.lineTo(L - 10 * Math.cos(u + Math.PI / 6), i - 10 * Math.sin(u + Math.PI / 6)),
        M.stroke()
    }
...
, function(M, j, t) {
    var L, i, N = {}, e = (L = function() {
        return window && document && document.all && !window.atob
    }
    ,
    function() {
        return void 0 === i && (i = L.apply(this, arguments)),
        i
    }
    ), u = function(M, j) {
        ...
        for (var t = 0; t < M.length; t++) {
            ...
            if (i) {
                ...
                for (var e = 0; e < i.parts.length; e++)
                    i.parts[e](L.parts[e]);
                for (; e < L.parts.length; e++)
                    i.parts.push(S(L.parts[e], j))
            } else {
                var u = [];
                for (e = 0; e < L.parts.length; e++)
                    u.push(S(L.parts[e], j));
                N[L.id] = {
                    id: L.id,
                    refs: 1,
                    parts: u
    ...
    function c(M, j) {
        for (var t = [], L = {}, i = 0; i < M.length; i++) {
            var N = M[i]
              , e = j.base ? N[0] + j.base : N[0]
              , u = {
                css: N[1],
                media: N[2],
                sourceMap: N[3]
            };
            L[e] ? L[e].parts.push(u) : t.push(L[e] = {
                id: e,
                parts: [u]
            })
        }
    ...
    function o(M, j) {
        ...
        var L = g[g.length - 1];
        if ("top" === M.insertAt)
            L ? L.nextSibling ? t.insertBefore(j, L.nextSibling) : t.appendChild(j) : t.insertBefore(j, t.firstChild),
            g.push(j);
        else if ("bottom" === M.insertAt)
            t.appendChild(j);
        else {
            if ("object" != typeof M.insertAt || !M.insertAt.before)
                throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contrib/style-loader#insertat)\n");
            var i = I(M.insertAt.before, t);
            t.insertBefore(j, i)
        }
    }
    function A(M) {
    ...
    function T(M) {
        ...
        if (void 0 === M.attrs.type && (M.attrs.type = "text/css"),
    ...
    function S(M, j) {
        ...
        if (j.transform && M.css) {
            if (!(N = "function" == typeof j.transform ? j.transform(M.css) : j.transform.default(M.css)))
                return function() {}
                ;
            M.css = N
        }
        if (j.singleton) {
            ...
            M.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = function(M) {
                var j = document.createElement("link");
                return void 0 === M.attrs.type && (M.attrs.type = "text/css"),
        ...
        function(j) {
            if (j) {
                if (j.css === M.css && j.media === M.media && j.sourceMap === M.sourceMap)
                    return;
                L(M = j)
            } else
                i()
    ...
    M.exports = function(M, j) {
        ...
        (j = j || {}).attrs = "object" == typeof j.attrs ? j.attrs : {},
        j.singleton || "boolean" == typeof j.singleton || (j.singleton = e()),
        j.insertInto || (j.insertInto = "head"),
        j.insertAt || (j.insertAt = "bottom");
        var t = c(M, j);
        return n(t, j),
        function(M) {
    ...
    function l(M, j, t, L) {
        var i = t ? "" : L.css;
        if (M.styleSheet)
            M.styleSheet.cssText = s(j, i);
        else {
            var N = document.createTextNode(i)
              , e = M.childNodes;
            e[j] && M.removeChild(e[j]),
            e.length ? M.insertBefore(N, e[j]) : M.appendChild(N)
        }
    }
    function x(M, j) {
        var t = j.css
          , L = j.media;
        if (L && M.setAttribute("media", L),
        M.styleSheet)
    ...
    function w(M, j, t) {
        var L = t.css
          , i = t.sourceMap
          , N = void 0 === j.convertToAbsoluteUrls && i;
        (j.convertToAbsoluteUrls || N) && (L = y(L)),
        i && (L += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
        var e = new Blob([L],{
            type: "text/css"
        })
          , u = M.href;
        M.href = URL.createObjectURL(e),
    ...
    function D(M, j, t=!1, D=!0) {
        ...
        function y() {
            ...
            if (M.has(j))
                if (void 0 !== j.target)
                    if (M.has(j.target)) {
                        const L = Object(N.d)(j.position, j.target.position, M)
                          , e = Object(i.b)(Object(i.t)(L, j.position), j.forward);
                        if (j.elevator = Math.sign(e) > 0 ? 1 : -1,
                        Object(i.a)(j.position, Object(i.e)(j.velocity, 4)).y > M.ground && (j.elevator = Math.sign(j.forward.x) > 0 ? -1 : 1),
                        t && Object(i.s)(j.position, j.target.position) < 180) {
                            const t = 30;
                            for (let L = 0; L < t; L++) {
                                const N = L;
                                setTimeout( () => {
                                    const L = Object(i.r)(j.forward, Object(i.j)(360 * N / t))
                                      , e = Object(u.d)(M, j);
                                    e.position = Object(i.a)(j.position, Object(i.e)(L, 160 * Math.random())),
                                    e.velocity = Object(i.a)(j.velocity, Object(i.e)(L, 60 * Math.random()))
                                }
                                , 220 * Math.random())
                            }
                            Object(u.d)(M, j),
                            ...
                            const L = 500;
                            for (let t = 0; t < L; t++) {
                                if (j.source instanceof a.a)
                                    return;
                                const N = new I.a(j.source)
                                  , e = Object(i.r)(j.forward, Object(i.j)(360 * t / L));
                                N.position = Object(i.a)(j.position, Object(i.e)(e, j.radius + 5)),
                                N.velocity = Object(i.a)(j.velocity, Object(i.e)(e, 220)),
                                M.add(N)
                            }
                        }
                    } else
                    ...
                    for (let u of M)
                        if (u instanceof e.a) {
                            if (u === j.source)
                                continue;
                            if (void 0 !== (null === (L = u.player) || void 0 === L ? void 0 : L.team) && void 0 !== (null === (D = j.source.player) || void 0 === D ? void 0 : D.team) && u.player.team === j.source.player.team)
                                continue;
                            const M = Object(i.s)(j.position, u.position);
                            M < N && (t = u,
                            N = M)
                        }
                    if (t) {
                        const M = Object(i.b)(Object(i.t)(t.position, j.position), j.forward);
                        (Math.abs(M) < Math.PI / 5 || N < 100) && (j.target = t)
                    }
                }
        }
        D ? j.setTimeout(g, 500) : g(),
        j.target = void 0
    }
}
, function(M, j) {
...
, function(M, j) {
    M.exports = "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNSIgaGVpZ2h0PSI1IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjxjaXJjbGUgc3Ryb2tlPSIjMDAwIiBmaWxsPSIjRDM5QTNDIiBjeD0iMi41IiBjeT0iMi41IiByPSIyIiBmaWxsLXJ1bGU9ImV2ZW5vZGQiLz48L3N2Zz4="
}
, function(M, j) {
...
, function(M, j) {
    M.exports = function(M) {
        ...
        return M.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, (function(M, j) {
            var i, N = j.trim().replace(/^"(.*)"$/, (function(M, j) {
                return j
            }
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(N) ? M : (i = 0 === N.indexOf("//") ? N : 0 === N.indexOf("/") ? t + N : L + N.replace(/^\.\//, ""),
...
, , function(M, j, t) {
    ...
    function O(M, j) {
        ...
        j.setInterval( () => {
            t = function(t) {
                ...
                for (let t of M)
                    if (t instanceof y.a) {
                        const M = Object(T.s)(j.position, t.position);
                        M < i && (L = t,
                        i = M)
                    }
                return L
            ...
            t && (j.running = !0,
            j.direction = j.position.x < t.position.x ? z.b.Left : z.b.Right,
            C(M, j))
        }
        , 1e3);
        const L = 300 * Math.random();
        j.setInterval( () => {
            Math.random() < .1 && C(M, j, T.q)
        }
        , 1e3 + L),
        j.setInterval( () => {
            t || (j.running = Math.random() < .1)
        ...
        , 1e3 + 2e3 * Math.random()),
        j.setInterval( () => {
            t || (j.direction = Math.random() < .5 ? z.b.Left : z.b.Right)
        }
        , 1e3 + 4e3 * Math.random())
    }
    function C(M, j, t) {
        ...
        const L = function(M, j) {
            const t = new w.a(M);
            t.move(Object(T.a)(M.position, Object(T.e)(M.normal, 10))),
            M.direction === z.b.Right ? (t.move(Object(T.a)(t.position, Object(T.e)(M.forward, 20))),
            t.forward = Object(T.r)(t.forward, T.p),
            t.normal = Object(T.r)(t.normal, T.p),
            t.angle = T.p) : (t.move(Object(T.a)(t.position, Object(T.e)(M.forward, -20))),
            t.forward = Object(T.r)(t.forward, T.k),
            t.normal = Object(T.r)(t.normal, T.k),
            t.angle = T.k);
            j && (t.forward = Object(T.r)(Object(T.c)(M.forward), j),
            t.normal = Object(T.r)(Object(T.c)(M.normal), j),
            t.angle = j);
            return t.velocity = Object(T.e)(M.normal, 20),
            t.thrust = 8,
            t
        }(j, t);
        j.timeout(u.m, () => L.justDeployed = !1),
        Object(x.a)(M, L, !1, !1),
        M.add(L)
    }
    var E = t(24);
    ...
    t(89);
    Object(S.c)((function() {
        if (o.c.killed > 1 && o.c.deaths > 1 && o.c.cowKilled > 1) {
            document.querySelector(".stats").innerHTML = `\n        You fired <em>${o.c.bullets.toLocaleString()}</em> <i class="ammo"></i> bullets \n        and <em>${o.c.missiles.toLocaleString()}</em> <i class="missile"></i> missiles\n        and destroyed <i class="target"></i> <em>${o.c.killed.toLocaleString()}</em> planes,\n        and unfortunately died <i class="skull"></i> <em>${o.c.deaths.toLocaleString()}</em> times. <br>\n        Also inadvertently you killed <em>${o.c.cowKilled.toLocaleString()}</em> <img src="${t(27)}" alt="cow" style="height: 14px"> cows. \n    `
        }
        let M = document.getElementsByName("nickname")[0];
        M.value = Object(o.a)("nickname") || "",
        M.addEventListener("keyup", j => Object(o.b)("nickname", M.value));
        ...
        let x = function() {
            ...
            M.ground = M.height - c.b.ground.height,
            M.players = [],
            M.onCrash = function(j) {
                ...
                setTimeout( () => {
                    ...
                    L.landed = !0,
                    L.ammo = 0,
                    L.move(Object(T.u)(M.width / 2 + (1200 * Math.random() - 600), M.ground)),
                    t.control(L),
                    M.add(L)
                }
                , 2e3)
            ...
            let j = Object(i.b)();
            for (let t = 0; t < u.i; t++) {
                const t = N.a.pop() || "no name"
                  , i = j.pop() || "black"
                  , e = new y.a(i)
                  , I = new n.a(t,i,e);
                e.player = I,
                M.players.push(I),
                e.ammo = e.maxAmmo = I.maxAmmo = u.b,
                e.move(Object(T.u)(M.width * Math.random(), M.ground * Math.random())),
                M.add(e),
                I.disableAI = Object(L.a)(M, I)
            }
            const t = document.querySelector(".demo")
              , [a,D] = Object(e.c)(1.25, t);
            let o = Object(I.a)(a, D, M, (j, t) => {
        ...
        Object(S.a)("#game").addEventListener("submit", M => {
            ...
            function(M) {
                switch (Object(S.a)("main").style.display = "none",
                Object(S.a)("#canvas").style.display = "block",
                Object(S.a)(".ui").style.display = "block",
                M) {
                case "death-match":
                    !function() {
                        const M = new r.a({
                        ...
                        M.onCrash = function(j) {
                            ...
                            setTimeout( () => {
                                ...
                                L.ammo = L.maxAmmo = t.maxAmmo,
                                L.landed = !0,
                                L.move(Object(T.u)(M.width * Math.random(), M.ground)),
                                t.control(L),
                                M.add(L)
                            }
                            , 2e3))
                        ...
                        Object(g.b)(M),
                        Object(g.a)(M);
                        let j = new D.a(M.width / 2 + 110,M.ground);
                        M.add(j);
                        const t = new y.a("#ff0015")
                          , S = new n.a(Object(o.a)("nickname") || "YOU","#ff0015",t);
                        S.isHuman = !0,
                        S.control(t),
                        M.players.push(S),
                        S.maxAmmo = u.f,
                        ...
                        t.ammo = u.f,
                        t.landed = !0,
                        t.move(Object(T.u)(M.width / 2, M.ground)),
                        M.add(t),
                        Object(a.a)(M, S, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        for (let j = 0; j < u.i; j++) {
                            ...
                            e.landed = !0,
                            e.move(Object(T.u)(j * M.width / u.i - 800, M.ground)),
                            M.add(e),
                            I.disableAI = Object(L.a)(M, I)
                        }
                        const s = document.querySelector("#canvas")
                          , [l,x] = Object(e.c)(1.25, s);
                        Object(I.a)(l, x, M, (j, t) => {
                            Object(e.a)(j, M, S, t)
                        }
                        , j => {
                            Object(A.h)(j, M.players)
                        }
                        ),
                        Object(A.e)(M)
                    }();
                ...
                case "teams":
                    !function() {
                        ...
                        j.name = "Red",
                        j.count = 5,
                        j.startingPosition = M.width / 2 + 1e3 + (M.width / 2 - 2e3) * Math.random();
                        const t = new n.b("#145ece");
                        t.count = 9,
                        t.name = "Blue",
                        t.startingPosition = 500 + (M.width / 2 - 500) * Math.random();
                        let i = location.search.match(/count=([0-9]+)vs([0-9]+)/);
                        i && (j.count = parseInt(i[1]),
                        t.count = parseInt(i[2]));
                        let S = new D.a(j.startingPosition,M.ground)
                          , z = new D.a(t.startingPosition,M.ground);
                        M.add(S),
                        M.add(z);
                        let s = new y.a("#ff0015")
                          , l = new n.a(Object(o.a)("nickname") || "YOU",s.color,s);
                        l.isHuman = !0,
                        l.join(j),
                        s.player = l,
                        M.players.push(l),
                        ...
                        s.ammo = u.f,
                        s.landed = !0,
                        s.move(Object(T.u)(j.startingPosition - 130, M.ground)),
                        M.add(s),
                        Object(a.a)(M, l, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        M.onCrash = function(j) {
                            if (j.player) {
                                j.player.detach();
                                const t = j.player.isHuman ? 5e3 : 12e3;
                                setTimeout( () => {
                                    const t = j.player;
                                    if (!t)
                                        return;
                                    ...
                                    if (!L)
                                        return;
                                    const i = new y.a(t.color);
                                    i.life = t.maxLife,
                                    i.ammo = i.maxAmmo = t.maxAmmo,
                                    i.landed = !0,
                                    i.move(Object(T.u)(L.startingPosition, M.ground)),
                                    t.control(i),
                                    M.add(i)
                                }
                                , t)
                        ...
                        for (let t = 1; t < j.count; t++)
                            setTimeout( () => {
                                ...
                                e.landed = !0,
                                e.move(Object(T.u)(j.startingPosition + 50 * t, M.ground)),
                                M.add(e),
                                I.disableAI = Object(L.a)(M, I)
                            }
                            , 1e3 * t);
                        for (let j = 0; j < t.count; j++)
                            setTimeout( () => {
                                ...
                                e.landed = !0,
                                e.move(Object(T.u)(t.startingPosition + 50 * j, M.ground)),
                                e.angle = 2 * Math.PI * Math.random(),
                                M.add(e),
                                I.disableAI = Object(L.a)(M, I)
                            }
                        ...
                        const x = document.querySelector("#canvas")
                          , [w,O] = Object(e.c)(1.25, x);
                        Object(I.a)(w, O, M, (j, t) => {
                            Object(e.a)(j, M, l, t)
                        }
                        , M => {
                            Object(A.j)(M, j, t)
                ...
                case "duel":
                    !function() {
                        ...
                        M.add(j);
                        const t = new y.a("#ff0015")
                          , i = new n.a(Object(o.a)("nickname") || "YOU","#ff0015",t);
                        i.isHuman = !0,
                        i.control(t),
                        M.players.push(i),
                        i.maxAmmo = u.f,
                        ...
                        const S = document.querySelector("#canvas")
                          , [z,s] = Object(e.c)(1.25, S);
                        Object(I.a)(z, s, M, (j, t) => {
                            Object(e.a)(j, M, i, t)
                        }
                        , j => {
                            Object(A.h)(j, M.players)
                ...
                case "survival":
                    !function() {
                        ...
                        let S, z = parseInt(t.get("size") || "2"), s = Object(i.b)(), l = new n.b("#ff0015"), x = new y.a(l.color), w = new n.a(Object(o.a)("nickname") || "YOU",l.color,x);
                        w.join(l),
                        w.isHuman = !0,
                        w.control(x),
                        M.players.push(w),
                        x.ammo = x.maxAmmo = w.maxAmmo = 100,
                        x.missiles = x.maxMissiles = w.maxMissiles = 10,
                        x.landed = !0,
                        x.move(Object(T.u)(M.width / 2 - 100, M.ground)),
                        M.add(x),
                        Object(a.a)(M, w, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        let O = () => {
                            ...
                            for (let j = 0; j < z; j++) {
                                const t = N.a.pop() || "no name"
                                  , i = new y.a(S.color)
                                  , e = new n.a(t,S.color,i);
                                e.number = j,
                                e.join(S),
                                0 === j && (S.leader = e),
                                e.control(i),
                                M.players.push(e),
                                i.ammo = i.maxAmmo = e.maxAmmo = u.b,
                ...
                case "swarm":
                    !function() {
                        ...
                        j = t = parseInt(i.get("size") || "50");
                        const D = new n.b("#ff0015")
                          , S = new n.b("#145ece");
                        let z = new y.a(D.color)
                          , s = new n.a(Object(o.a)("nickname") || "YOU",D.color,z);
                        z.thrust = u.j,
                        s.isHuman = !0,
                        s.join(D),
                        D.leader = s,
                        ...
                        z.maxAmmo = u.f,
                        z.ammo = u.f,
                        z.move(Object(T.u)(3 * M.width / 4, M.height / 2)),
                        M.add(z);
                        const l = Object(a.a)(M, s, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                                down: ["ArrowDown", "KeyS"]
                            },
                        ...
                        M.onCrash = function(M) {
                            ...
                            clearTimeout(w),
                            w = window.setTimeout( () => {
                                let M = D.members.filter(M => M.hasPlane()).length
                                  , j = S.members.filter(M => M.hasPlane()).length;
                                0 != M && 0 != j || (0 != M && 0 == j && alert("You won! 🎉"),
                        ...
                        for (let t = 1; t < j; t++) {
                            ...
                            i.maxAmmo = u.f,
                            i.ammo = u.f,
                            i.move(Object(T.u)(3 * M.width / 4 + 100 * Math.random(), M.height / 2 + 100 * Math.random())),
                            M.add(i),
                            e.disableAI = Object(L.a)(M, e),
                            x.push(e)
                        }
                        for (let j = 0; j < t; j++) {
                            ...
                            i.maxAmmo = u.f,
                            i.ammo = u.f,
                            i.move(Object(T.u)(1 * M.width / 4 + 100 * Math.random(), M.height / 2 + 100 * Math.random())),
                            i.angle = 2 * Math.PI * Math.random(),
                            M.add(i),
                            e.disableAI = Object(L.a)(M, e)
                        }
                        const O = document.querySelector("#canvas")
                          , [C,E] = Object(e.c)(1.25, O);
                        Object(I.a)(C, E, M, (j, t) => {
                            Object(e.a)(j, M, s, t)
                        }
                        , M => {}
                        ),
                ...
                case "revenge":
                    !function() {
                        ...
                        for (let t = u.g; t >= 0; t--) {
                            ...
                            t.player = L,
                            L.join(j),
                            t.move(Object(T.u)(Math.random() * M.width, M.ground - t.sprite.height / 2)),
                            O(M, t),
                            M.add(t)
                        }
                        M.onCowKill = j => {
                            ...
                            j.destroy(),
                            j.dead = !0;
                            let t = new s.d(c.b.cowDead);
                            t.position = j.position,
                            t.position.y = M.ground - t.sprite.height + 2,
                            M.groundObjects.add(t),
                            setTimeout( () => M.groundObjects.delete(t), 30 * u.m),
                            Object(l.a)(M, j),
                            i.kills++
                        }
                        ;
                        const t = new n.b("#ff0015")
                          , L = new y.a("#ff0015")
                          , i = new n.a(Object(o.a)("nickname") || "YOU","#ff0015",L);
                        i.join(t),
                        i.isHuman = !0,
                        i.control(L),
                        M.players.push(i),
                        ...
                        L.maxAmmo = u.f,
                        L.ammo = u.f,
                        L.move(Object(T.u)(M.width / 2, -300)),
                        M.add(L),
                        Object(a.a)(M, i, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        const N = document.querySelector("#canvas")
                          , [D,S] = Object(e.c)(1.25, N);
                        Object(I.a)(D, S, M, (j, t) => {
                            Object(e.a)(j, M, i, t)
                        }
                        , M => {
                            Object(A.g)(M, i)
                ...
                case "split-duel":
                    !function() {
                        var M;
                        null === (M = document.querySelector(".cockpit")) || void 0 === M || M.remove();
                        const j = new r.a({
                            width: 15e3,
                            height: 4e3,
                            ground: 0,
                        ...
                        j.ground = j.height - c.b.ground.height,
                        j.players = [],
                        j.onCrash = function(M) {
                            M.player && (M.player.detach(),
                            setTimeout( () => {
                                const t = M.player;
                                if (!t)
                                    return;
                                ...
                                L.ammo = L.maxAmmo = t.maxAmmo,
                                L.landed = !0,
                                L.move(Object(T.u)(j.width * Math.random(), j.ground)),
                                t.control(L),
                                j.add(L)
                            }
                            , 2e3))
                        ...
                        Object(g.b)(j),
                        Object(g.a)(j);
                        let t = new D.a(j.width / 2 + 110,j.ground);
                        j.add(t);
                        const L = Math.random() < .5
                          , i = new n.a("Player 1","#ff0015");
                        {
                            const M = new y.a(i.color);
                            i.control(M),
                            i.isHuman = !0,
                            i.control(M),
                            j.players.push(i),
                            ...
                            M.ammo = u.f,
                            M.landed = !0,
                            M.move(Object(T.u)(j.width / 2 + (L ? -300 : 450), j.ground)),
                            j.add(M),
                            Object(a.a)(j, i, {
                                thrustLevers: {
                                    up: ["ArrowUp"],
                        ...
                        const N = new n.a("Player 2","#0066ff");
                        {
                            const M = new y.a(N.color);
                            N.control(M),
                            N.isHuman = !0,
                            N.control(M),
                            j.players.push(N),
                            ...
                            M.ammo = u.f,
                            M.landed = !0,
                            M.move(Object(T.u)(j.width / 2 + (L ? 450 : -300), j.ground)),
                            j.add(M),
                            Object(a.a)(j, N, {
                                thrustLevers: {
                                    up: ["KeyW"],
                        ...
                        const o = document.querySelector("#canvas")
                          , [S,z] = Object(e.c)(1.25, o)
                          , s = document.querySelector("#canvas1");
                        s.style.display = "block";
                        const [l,x] = Object(e.c)(1.25, s);
                        s.style.display = "none";
                        const w = document.querySelector("#canvas2");
                        w.style.display = "block";
                        const [O,C] = Object(e.c)(1.25, w);
                        w.style.display = "none";
                        let d = !1;
                        setInterval( () => {
                            const M = i.hasPlane() || i.hasPilot()
                              , j = N.hasPlane() || N.hasPilot();
                            M && j && (Object(T.s)(M.position, j.position) > Math.min(S.width, S.height) ? (d = !0,
                            o.style.display = "none",
                            s.style.display = "block",
                            w.style.display = "block") : (d = !1,
                        ...
                        , 300);
                        const m = M => {
                            Object(A.h)(M, j.players),
                            Object(A.f)(M, i, S.width / 2 - 100),
                            Object(A.f)(M, N, S.width / 2 + 100)
                        }
                          , h = M => {
                            Object(A.h)(M, j.players),
                            Object(A.f)(M, i, S.width / 2 - 100)
                        ...
                        ;
                        Object(I.b)(S, j, (M, t) => {
                            d ? (Object(e.a)(l, j, i, t),
                            Object(e.a)(O, j, N, t),
                            Object(E.a)(x, l, j, t, h),
                            Object(E.a)(C, O, j, t, U)) : (Object(e.b)(M, j, i, N, t),
                            Object(E.a)(z, M, j, t, m))
                        }
                        ),
                        Object(A.e)(j)
                    }();
                ...
                case "playground":
                    !function() {
                        ...
                        M.players.push(t),
                        t.control(j),
                        j.move(Object(T.u)(M.width / 2 - 200, 500)),
                        M.add(j),
                        Object(a.a)(M, t, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        j.thrust = u.j;
                        {
                            ...
                            i.thrust = u.j,
                            setInterval( () => {
                                i.pointTo = Object(L.b)(M, i, T.p)
                            }
                            , 100)
                        }
                        const i = document.querySelector("#canvas")
                          , [D,o] = Object(e.c)(1.25, i);
                        Object(I.a)(D, o, M, (j, L) => {
                            Object(e.a)(j, M, t, L)
                        }
                        , M => {}
                        )
